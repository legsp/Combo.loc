     ...
     Redux::setSection( $opt_name, array(
       ...
       'fields'           => array(
         ...
         array(
          ...
          'type'      => 'slider',
          'title'     => esc_html__('Left Header Width', 'salient'),
          'desc'      => '',
          "default"   => 275,
          "min"       => 75,
          "step"      => 1,
          "max"       => 350,
          'subtitle' => esc_html__('Set the width of your header.', 'salient'),
          'required' => array( array( 'header_format', '=', 'left-header' ) ),
          'display_value' => 'label',
        ),
        array(
          'id' => 'left-header-padding',
          'type' => 'slider',
          'title' => esc_html__('Left Header Padding', 'salient'),
          'desc' => '',
          "default"   => 30,
          "min"       => 10,
          "step"      => 1,
          "max"       => 40,
          'subtitle' => esc_html__('Set the padding of your header.', 'salient'),
          'required' => array( array( 'header_format', '=', 'left-header' ) ),
          'display_value' => 'label',
        ),
      ...
      $blog_layout_options = array(
       ...
       $blog_styling_options = array(
        ...
        array(
          ...
          'subtitle' => esc_html__('Using this will automatically generate excerpts for your posts when using blog styles that typically display the full content by default, such as the "Classic" styles.', 'salient'),
          'desc' => '',
          'default' => '1'
        ),
       ...
       Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
          ...
          array(
            ...
            'options' => array(
              'default' => esc_html__('Default', 'salient'),
              'var(--container-width)' => esc_html__('Match Global Container', 'salient'),
