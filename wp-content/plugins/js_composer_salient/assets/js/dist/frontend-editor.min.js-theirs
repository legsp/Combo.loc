      ...
      checkNoContent: function() {
       ...
       /* nectar addition - portfolio post type FE save */
        save: function(e, t) {
          ...
          o.vc_post_custom_css = window.vc.$custom_css.val(),
          o.vc_post_custom_js_header = window.vc.$custom_js_header.val(),
          o.vc_post_custom_js_footer = window.vc.$custom_js_footer.val();
          if(vc.frame_window.jQuery('body.single-portfolio').length > 0) {
            o.nectar_post_type = 'portfolio';
          } else {
            o.nectar_post_type = 'std';
          }
          // o.vc_post_custom_layout = s("#vc_post-custom-layout").val(),
          o.vc_post_custom_seo_settings = s("#vc_post-custom-seo-settings").val(),
          o.content = this.wpautop(n), e && (o.post_status = e, s(".vc_button_save_draft").hide(100), s("#vc_button-update p").text(window.i18nLocale.update_all)), window.vc.update_title && (o.post_title = this.getTitle()), this.ajax(o).done(function() {
