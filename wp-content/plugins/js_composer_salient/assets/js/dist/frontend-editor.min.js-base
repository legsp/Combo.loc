...
(e => {
  e.vc || (e.vc = {}), e.vc.utils = {
      ...
      copyTextToClipboard: function(e) {
          navigator.clipboard ? navigator.clipboard.writeText(e) : this.fallbackCopyTextToClipboard(e)
      },
      slugify: function(e) {
          return (e = e || "").toString().toLowerCase().replace(/[^\w\s-]/g, "").replace(/[\s_-]+/g, "-").replace(/(\s+$)|(^\s+)/g, "").trim()
      }
  }
})(window);
(s => {
  ...
  var r = Backbone.View.extend({
      ...
      h = (window.i18nLocale, vc.edit_form_callbacks = [], vc.atts = {
          ...
          parse: function(t) {
              ...
              try {
                  n = window.vc.utils.fixUnclosedTags(t.val())
              } catch (e) {
                  n = t.val(), console.error("Failed to execute window.vc.utils.fixUnclosedTags function: ", e)
              }
...
(s => {
  void 0 === window.vc && (window.vc = {}), window.vc.ShortcodesBuilder = function(e) {
      ...
      buildFromTemplate: function(e, t) {
          ...
          }, this), window.vc.frame.setSortable(), window.vc.activity = !1, this.checkNoContent(), window.vc.frame_window.vc_iframe.loadScripts(), this.last() && window.vc.frame.scrollTo(this.first()), this.models = [], this.showResultMessage(), window.vc.frame.render(), this.is_build_complete = !0, i
      },
      ...
      save: function(e, t) {
          ...
          o.vc_post_custom_css = window.vc.$custom_css.val(), o.vc_post_custom_js_header = window.vc.$custom_js_header.val(), o.vc_post_custom_js_footer = window.vc.$custom_js_footer.val(), o.vc_post_custom_layout = s("#vc_post-custom-layout").val(), o.vc_post_custom_seo_settings = s("#vc_post-custom-seo-settings").val(), o.post_name = window.vc.utils.slugify(s("#vc_post_name").val()), o.vc_post_template = s("#vc_post_template option:selected").val(), o.post_excerpt = s("#vc_post_excerpt").val(), o.vc_post_author = s("#vc_post_author").val(), o.vc_post_comments = s("#vc_post_comments").is(":checked"), o.vc_post_pingbacks = s("#vc_post_pingbacks").is(":checked"), o.vc_post_featured_image = s("#vc_settings-featured-image .featured_image").val(), o.vc_selected_categories = s("#vc_post-category").val(), o.vc_post_tags = this.parseSelect2Tags(s("#vc_post-tags").val()), o.content = this.wpautop(n), e && (o.post_status = e, s(".vc_button_save_draft").hide(100), s("#vc_button-update p").text(window.i18nLocale.update_all)), o.post_title = s("#vc_page-title-field").val(), o.is_hide_title = s("#wpb_post-hide-title").is(":checked"), this.ajax(o).done(function() {
...
(r => {
  _.isUndefined(window.vc) && (window.vc = {}), r.ajaxSetup({
      ...
      hide: function(e) {
          this.deactivatePageSettingsStatus(), this.isPageSettingsChanged() ? confirm(window.i18nLocale.page_settings_confirm) && (vc.PanelView.prototype.hide.call(this, e), this.rollBackChanges()) : vc.PanelView.prototype.hide.call(this, e), this.trigger("hide")
      },
      isPageSettingsChanged: function() {
          if (window.vc.page_settings_editor) {
              var e, t = window.vc.page_settings_editor;
      ...
      rollBackChanges: function() {
          var e, t = window.vc.page_settings_editor;
          for (e of Object.keys(t)) {
              var i = t[e].currentValue,
                  a = t[e].previousValue,
                  n = this.$settingsFields.filter("#" + e);
              t[e].currentValue = a, n.val(a), "vc_featured_image" === e && n.next(".gallery_widget_attached_images").find(".vc_icon-remove").trigger("click"), "checkbox" === n.attr("type") && i !== a && n.next("label").trigger("click")
          }
          var s = new CustomEvent("wpbPageSettingRollBack", {
              detail: t
          });
      ...
      changeTab: function(e) {
          ...
          if (t.filter('[data-tab-index="' + e + '"]').addClass("vc_active"), 1 === e && window.vc.page_settings_editor)
              for (var i of Object.keys(window.vc.page_settings_editor)) window.vc.page_settings_editor[i].editor && window.vc.page_settings_editor[i].editor.resize()
      },
      ...
      handleSettingsChange: function(e) {
          ...
          window.vc.page_settings_editor || (window.vc.page_settings_editor = {}), e.attr("data-post-custom-layout") || (t = e.val(), "checkbox" === e.attr("type") && (t = e.is(":checked")), window.vc.page_settings_editor[e.attr("id")] && (window.vc.page_settings_editor[e.attr("id")] = {
              previousValue: window.vc.page_settings_editor[e.attr("id")].previousValue,
              currentValue: t
          }))
      },
      setFieldValues: function() {
          window.vc.page_settings_editor || (window.vc.page_settings_editor = {}), this.$settingsFields.each(function() {
              var e = r(this),
                  t = e.val();
              "checkbox" === e.attr("type") && (t = e.is(":checked")), window.vc.page_settings_editor[e.attr("id")] = {
                  previousValue: t,
                  currentValue: t
              }
          })
...
(o => {
  window.vc.element_start_index = 0, window.vc.AddElementUIPanelBackendEditor = vc.PanelView.vcExtendUI(vc.HelperPanelViewHeaderFooter).extend({
      ...
      events: {
          'click [data-vc-ui-element="button-close"]': "hide",
          'touchstart [data-vc-ui-element="button-close"]': "hide",
          'click [data-vc-ui-element="panel-tab-control"]': "handleFiltering",
          "click .vc_shortcode-link": "createElement",
...
_.isUndefined(window.vc) && (window.vc = {}), _.extend(vc, {
  ...
  vc.map = {}, vc.setFrameSize = function(e) {
      ...
      var d, s = vc.getDefaultsAndDependencyMap(i),
          l = {};
      return r = _.extend({}, s.defaults, r), d = _.extend({}, s.dependencyMap), _.each(r, function(e, t) {
          if ("content" !== t) {
              if (!_.isUndefined(d[t])) {
                  if (!_.isUndefined(d[d[t].element]) && _.isBoolean(d[d[t].element].failed) && !0 === d[d[t].element].failed) return void(d[t].failed = !0);
                  var n, a = d[t].element,
                      o = r[a],
                      c = !1;
      ...
      checkControlsPosition: function() {
          var e, t;
          this.$controls_buttons && (t = this.$el.height(), vc.$frame.height() < t) && (e = s(vc.frame_window).scrollTop(), this.$controls_buttons.offset().top, 40 < (e = e - this.$el.offset().top + vc.$frame.height() / 2) && e < t ? this.$controls_buttons.css("top", e) : t < e ? this.$controls_buttons.css("top", t - 40) : this.$controls_buttons.css("top", 40))
      },
      ...
      addControls: function() {
          ...
          this.$controls = s(c(e).trim()).addClass("vc_controls"), this.$controls.appendTo(this.$el), this.$controls_buttons = this.$controls.find("> :first")
      },
      content: function() {
      ...
      _getDefaultTemplate: function() {
          var e;
          return !_.isUndefined(this.default_controls_template) && this.default_controls_template || (this.default_controls_template = s("<div><div>").html(s("#vc_controls-template-default").html()), e = this.$el.data("shortcode-controls"), _.isUndefined(e)) || s(".vc_control-btn[data-control]", this.default_controls_template).each(function() {
              -1 == s.inArray(s(this).data("control"), e) && s(this).remove()
      ...
      openTemplatesWindow: function(e) {
          vc.templates_panel_view.once("show", function() {
              s('[data-vc-ui-element-target="[data-tab=default_templates]"]').click()
          }), vc.app.openTemplatesWindow.call(this, e)
      },
      updateKeyPress: function(e) {
          if (13 === e.which) return e && e.preventDefault && e.preventDefault(), vc.$title.attr("contenteditable", !1), s(".entry-content").trigger("click"), !1
      },
      loadDefaultTemplate: function(e) {
          e && e.preventDefault && e.preventDefault(), vc.templates_panel_view.loadTemplate(e), s("#vc_no-content-helper").remove()
      },
      initialize: function() {
          vc.frame_window = vc.$frame.get(0).contentWindow, s(vc.frame_window.document.body).on("paste", this.handleEditorPaste)
      },
      ...
      setActiveHover: function(e) {
          this.$hover_element && this.$hover_element.removeClass("vc_hover"), this.$hover_element = s(e.currentTarget).addClass("vc_hover"), e.stopPropagation()
      },
      ...
      render: function() {
          return !1 !== vc_user_access().getState("post_settings") && (vc.$title = s(vc.$frame.get(0).contentWindow.document).find('h1:contains("' + (vc.title || vc.no_title_placeholder).replace(/"/g, '\\"') + '")'), vc.$title.on("click", function(e) {
              e.preventDefault(), vc.post_settings_view.render().show(), s("#vc_page-title-field").focus()
          })), s(vc.$frame.get(0).contentWindow.document).find(".wpb-content-wrapper").length || window.vc.showMessage(window.i18nLocale.not_editable_post || "This post can not be edited with WPBakery since it is missing a WordPress default content area.", "error", "30000"), this
      },
      ...
      render: function() {
          return vc.updateSettingsBadge(), vc.$page = s(vc.$frame.get(0).contentWindow.document).find("#vc_inline-anchor").parent(), vc.$frame_body = s(vc.$frame.get(0).contentWindow.document).find("body").addClass("vc_editor"), this.setMode("compose"), this.$size_control = s("#vc_screen-size-control"), s(".vc_element-container", vc.frame_window.document).droppable({
              accept: ".vc_element_button"
          }), s(window).on("resize", this.resizeWindow), _.defer(function() {
              vc.events.trigger("app.render")
          }), this
      },
      cancel: function(e) {
          e && e.preventDefault && e.preventDefault(), window.location.href = s(e.currentTarget).data("url")
      },
      save: function(e) {
          e && e.preventDefault && e.preventDefault(), vc.builder.save(s(e.currentTarget).data("changeStatus"))
      },
      resizeFrame: function(e) {
          var t = s(e.currentTarget);
          if (e && e.preventDefault && e.preventDefault(), t.hasClass("active")) return !1;
          this.$size_control.find(".active").removeClass("active"), s("#vc_screen-size-current").attr("class", "vc_current-layout-icon " + t.attr("class")), this.current_size = t.data("size"), t.addClass("active"), vc.setFrameSize(this.current_size)
      },
      editCloned: function(e) {
          e && e.preventDefault && e.preventDefault(), e = s(e.currentTarget).data("modelId"), e = vc.shortcodes.get(e), vc.edit_element_block_view.render(e)
      },
      ...
      setMode: function(e) {
          var t = s("body").removeClass(this.mode + "-mode");
          ...
          _.defer(function() {
              ...
              r.each(function(e) {
                  ...
                  a.is(".droppable") ? (o = {}, c = {
                      ...
                      params: o,
                      order: e
                  }, 0 === e ? vc.activity = "prepend" : e + 1 !== r.length && (t.place_after_id = vc.$page.find("> [data-tag=vc_row]:eq(" + (e - 1) + ")").data("modelId")), d.create(t).create({
                      shortcode: "vc_column",
                      parent_id: d.lastID(),
                      params: c
