(e => {
  e.vc || (e.vc = {}), e.vc.utils = {
      ...
      validateHtml: function(t) {
          if (!t.includes("<")) return t;
          try {
              return (new DOMParser).parseFromString(t, "text/html").body.innerHTML
          } catch (e) {
              return console.error("Failed to execute window.vc.utils.validateHtml function: ", e), t.replace(/</g, "&lt;").replace(/>/g, "&gt;")
          }
      },
      ...
      isBase64: function(e) {
          return /^[A-Za-z0-9+/]+={0,2}$/.test(e) && e.length % 4 == 0
      }
  }
})(window);
window.vc || (window.vc = {}), (() => {
...
window.vc.HelperPanelViewDraggable = {
  ...
  initDraggable: function() {
      window.matchMedia("(max-width: 767px )").matches || this.$el.draggable(_.extend({}, this.draggableOptions, {
          start: this.fixElContainment,
          stop: this.fixElContainment
      }))
  }
...
(a => {
  window.vc.HelperTemplatesPanelViewSearch = {
      ...
      searchTemplate: function(e) {
          e = a(e.currentTarget);
          e.val().length ? (this.$el.find(".vc_panel-tabs-control.vc_active").length && (this.lastActiveTab = this.$el.find(".vc_panel-tabs-control").index(this.$el.find(".vc_panel-tabs-control.vc_active"))), this.searchByName(e.val())) : this.clearSearch()
      },
      ...
      searchByName: function(e) {
          ...
          this.$el.find(".vc_panel-tabs-control.vc_active").removeClass("vc_active"), this.$el.attr("data-vc-template-search", "true"), this.$el.find("[data-template_name]").css("display", "none"), this.$el.find('[data-template_name*="' + vc_slugify(e) + '"]').css("display", "block"), this.$el.find('[data-vc-ui-element="panel-edit-element-tab"]').each(function() {
              var e = a(this);
              e.removeClass("vc-search-result-empty"), e.find("[data-template_name]:visible").length ? t = !0 : e.addClass("vc-search-result-empty")
          }), t ? a(this.noTemplateSelector).hide() : a(this.noTemplateSelector).show()
      }
  }
})(window.jQuery);
(d => {
  ...
  window.vc.EditElementPanelView = vc.PanelView.vcExtendUI(vc.HelperAjax).vcExtendUI(vc.ExtendPresets).vcExtendUI(vc.ExtendTemplates).vcExtendUI(vc.HelperPrompts).extend({
      ...
      buildParamsContent: function(e) {
          var t, n, i, a = this.model.get("id"),
              ...
              s = (e = this.removeExternalScriptsFromDataHtml(e), (t = (e = l(e)).find('[data-vc-ui-element="panel-tabs-controls"]')).find(".vc_edit-form-tab-control:first-child").addClass("vc_active"), n = this.$el.find('[data-vc-ui-element="panel-header-content"]'), (i = e.find('[data-vc-ui-element="panel-edit-element-tab"]')) && i.addClass("visually-hidden"), n && n.addClass("visually-hidden"), this.$content.html(e)),
               /* nectar addition - nectarVcAfterRenderBindThis in call back (d) */
          ...
          function nectarVcAfterRender() {
            ...
            function updateHotSpotData(rel,x,y) {
                ...
                // trigger keyup event for autosave compatibility
                if (jQuery('.hotspot-content[data-rel="'+rel+'"] textarea').length > 0) {
                    jQuery('.hotspot-content[data-rel="'+rel+'"] textarea').trigger('change');
                }
      ...
      save: function(e) {
        ...
        if(jQuery('[data-vc-shortcode="nectar_image_with_hotspots"]').length > 0 && this.$convertedData.length > 0) {
            ...
            if (hasTinymce) {
                ...
                if (editor) {
                    editor.setContent(this.$convertedData);
                }
            }
        }
            /* nectar addition end */
          var t = this.model.get("id");
          this.removeElementEditElementPanelCache(t), vc.saveInProcess = !0;
          e = e && e.target && e.target.classList.contains("textarea_html") || !!(e && e.target && e.target.closest(".vc_ui-panel-footer-container")) && !!(t = e.target.closest(".vc_ui-panel-window-inner")) && (t = l(t).find(".vc_ui-panel-content-container")) && 0 < t.find(".html-active").length;
          if (this.panelInit && this.model) {
              var t = this,
                  n = t.model.get("shortcode"),
                  i = t.getParams(),
                  a = _.extend({}, vc.getDefaults(n), vc.getMergedParams(n, i));
              if (!_.isUndefined(i.content)) {
                  if (e) try {
                      i.content = window.vc.utils.fixUnclosedTags(i.content), i.content = window.vc.utils.validateHtml(i.content)
                  } catch (e) {
              ...
              t.model.save({
                  params: a
              }), t.showMessage(window.sprintf(window.i18nLocale.inline_element_saved, vc.getMapped(n).name), "success"), window.vc_auto_save || window.vc.frame_window || this.hide(), t.trigger("save"), vc.saveInProcess = !1
          }
      },
      show: function() {
      ...
      checkTabs: function() {
          ...
          !1 === this.tabsInit && (this.tabsInit = !0, this.$tabsMenu = this.$el.find('[data-vc-ui-element="panel-tabs-controls"]')), this.tabsMenu() && (this.content().find('[data-vc-ui-element="panel-edit-element-tab"]').each(function(e) {
              var t = n.$tabsMenu.find('> [data-tab-index="' + e + '"]');
              l(this).find('[data-vc-ui-element="panel-shortcode-param"]:not(".vc_dependent-hidden")').length ? t.hasClass("vc_dependent-hidden") && (t.removeClass("vc_dependent-hidden"), window.setTimeout(function() {
                  t.removeClass("vc_tab-color-animated")
      ...
      init: function() {
          /* nectar addition */
            ...
            jQuery('select[name=type]').length > 0 && jQuery('select[name=type]').val() == 'parallax_image_grid') head.appendChild(style);
                const media = d; // nectar addition - verify d is the active media object above i.e. d.vc_editor - d could be renamed in the future
...
_.isUndefined(window.vc) && (window.vc = {}), window.vc.filters = {
  templates: []
}, window.vc.addTemplateFilter = function(t) {
  _.isFunction(t) && this.filters.templates.push(t)
}, (d => {
  function a(t) {
      return encodeURIComponent(t).replace(/[!'()*]/g, escape)
  }

  function i(t, e) {
      this.el = t, this.$el = d(this.el), this.$el_wrap = "", this.$block = "", this.suggester = "", this.selected_items = [], this.options = _.isObject(e) ? e : {}, _.defaults(this.options, {
  ...
  window.init_textarea_html = function(e) {
      var n, t, a, i = d("#wp-link");
      i.parent().hasClass("wp-dialog") && i.wpdialog("destroy"), n = e.attr("id"), t = (i = e.closest(".edit_form_line")).find(".vc_textarea_html_content");
      try {
          _.isUndefined(tinyMCEPreInit.qtInit[n]) && (window.tinyMCEPreInit.qtInit[n] = _.extend({}, window.tinyMCEPreInit.qtInit[window.wpActiveEditor], {
              ...
              setup: function(t) {
                  var e;
                  void 0 !== t.onLoadContent && t.onLoadContent.add(function() {
                      var t = setTimeout(function() {
                          1 === d("#" + n).size() && (d(".vc_edit-form-tab *:input[type!=hidden]:first").focus(), clearTimeout(t))
                      }, 100)
                  }), void 0 !== t.on ? (t.on("init", function() {
                      window.wpActiveEditor = n
                  }), window.vc_auto_save && (e = _.debounce(function() {
                      vc.edit_element_block_view.save(), a = !1
                  }, 500), t.on("keyup", function() {
                      a = !0, vc.saveInProcess = !0, e()
                  }), t.on("blur", function() {
                      a && !vc.saveInProcess && (vc.saveInProcess = !0, vc.edit_element_block_view.save(), a = !1)
                  }), t.on("ExecCommand", e), d("#wpb_tinymce_content").on("change", function() {
                      a = !0, vc.saveInProcess = !0, e()
                  }))) : t.onInit.add(function() {
                      window.wpActiveEditor = n
                  })
              }
          }), window.tinyMCEPreInit.mceInit[n].plugins = window.tinyMCEPreInit.mceInit[n].plugins.replace(/,?wpfullscreen/, ""), window.tinyMCEPreInit.mceInit[n].wp_autoresize_on = !1), vc.edit_element_block_view && vc.edit_element_block_view.currentModelParams ? e.val(vc_wpautop(vc.edit_element_block_view.currentModelParams[t.attr("name")] || "")) : e.val(t.val()), quicktags(window.tinyMCEPreInit.qtInit[n]), QTags._buttonsInit(), window.tinymce && (window.switchEditors && window.switchEditors.go(n, "tmce"), "4" === tinymce.majorVersion) && tinymce.execCommand("mceAddEditor", !0, n), window.wpActiveEditor = n
      } catch (t) {
          e.data("vcTinyMceDisabled", !0).appendTo(i), d("#wp-" + n + "-wrap").remove(), console && console.error && (console.error("VC: Tinymce error! Compatibility problem with other plugins."), console.error(t))
      }
      ...
      if (t.length < 6)
          for (var e = 6 - t.length - 1; 0 <= e; e--) t = "0" + t;
      return "#" + t
  }, vc.loop_partial = function(t, e, n, a) {
      n = _.isObject(n) && !_.isUndefined(n[e]) ? n[e] : "";
      return vc.template(d("#_vcl-" + t).html(), vc.templateOptions.custom)({
          name: e,
          data: n,
          settings: a
      })
  }, vc.loop_field_not_hidden = function(t, e) {
      return !(_.isObject(e[t]) && _.isBoolean(e[t].hidden) && !0 === e[t].hidden)
  }, vc.is_locked = function(t) {
      return _.isObject(t) && _.isBoolean(t.locked) && !0 === t.locked
  }, i.prototype = {
      constructor: i,
      init: function() {
          _.bindAll(this, "buildSource", "itemSelected", "labelClick", "setFocus", "resize"), this.$el.wrap('<ul class="' + this.options.css_class + '"><li class="input"/></ul>'), this.$el_wrap = this.$el.parent(), this.$block = this.$el_wrap.closest("ul").append(d('<li class="clear"/>')), this.$el.on("focus", this.resize).on("blur", function() {
              ...
              return d('<li data-value="' + e.value + '">').append("<a>" + e.name + "</a>").appendTo(t)
          }, this.$el.autocomplete("widget").addClass("vc_ui-front"), _.isArray(this.options.predefined) && _.each(this.options.predefined, function(t) {
              this.create(t)
          }, this)
      },
      resize: function() {
          var t = this.$el_wrap.position(),
              e = this.$block.position();
          this.$el_wrap.width(parseFloat(this.$block.width()) - (parseFloat(t.left) - parseFloat(e.left) + 4))
      },
      setFocus: function(t) {
          t.preventDefault(), d(t.target).hasClass(this.options.css_class) && this.$el.trigger("focus")
      },
      itemSelected: function(t, e) {
          return this.$el.blur(), this.create(e.item), this.$el.trigger("focus"), !1
      },
      create: function(t) {
          var e, n = this.selected_items.push(t) - 1,
              a = !0 === this.options.check_locked_callback(this.$el, t) ? "" : ' <a class="remove">&times;</a>';
          _.isUndefined(this.selected_items[n].action) && (this.selected_items[n].action = "+"), e = "-" === this.selected_items[n].action ? " exclude" : " include", (e = d('<li class="vc_suggest-label' + e + '" data-index="' + n + '" data-value="' + t.value + '"><span class="label">' + t.name + "</span>" + a + "</li>")).insertBefore(this.$el_wrap), _.isEmpty(a) || e.on("click", this.labelClick), this.options.select_callback(e, this.selected_items)
      },
      labelClick: function(t) {
          t.preventDefault();
          var e = d(t.currentTarget),
              n = parseInt(e.data("index"), 10);
          if (d(t.target).is(".remove")) return this.selected_items.splice(n, 1), this.options.remove_callback(e, this.selected_items), e.remove(), !1;
          this.selected_items[n].action = "+" === this.selected_items[n].action ? "-" : "+", "+" === this.selected_items[n].action ? e.removeClass("exclude").addClass("include") : e.removeClass("include").addClass("exclude"), this.options.update_callback(e, this.selected_items)
      },
      buildSource: function(t, e) {
          this.ajax && (this.ajax.abort(), e([]), this.ajax = !1);
          var n = _.filter(_.map(this.selected_items, function(t) {
      ...
      return this.each(function() {
          var t = d(this),
              e = t.data("suggester");
          e || t.data("suggester", e = new i(this, n)), "string" == typeof n && e[n]()
      })
  };
  var e = Backbone.View.extend({
          ...
          render: function(t) {
              var e = vc.template(d("#vcl-loop-frame").html(), _.extend({}, vc.templateOptions.custom, {
                  variable: "loop"
              }));
              return this.controller = t, this.$el.html(e(this.model)), this.controller.$el.append(this.$el), _.each(d("[data-suggest]"), function(t) {
                  var t = d(t),
                      e = window.decodeURIComponent(d("[data-suggest-prefill=" + t.data("suggest") + "]").val());
                  t.suggester({
                      predefined: d.parseJSON(e),
          ...
          save: function() {
              this.return_array = {}, _.each(this.model, function(t, e) {
                  t = this.getValue(e, t);
                  _.isString(t) && !_.isEmpty(t) && (this.return_array[e] = t)
              }, this), this.controller.setInputValue(this.return_array)
          },
          getValue: function(t) {
              return d("[name=" + t + "]", this.$el).val()
          },
          hide: function() {
              this.$el.slideUp()
          },
          ...
          updateCheckbox: function(t) {
              var t = d(t.currentTarget).data("input"),
                  e = d("[data-name=" + t + "]", this.$el),
                  n = [];
              d("[data-input=" + t + "]:checked").each(function() {
                  n.push(d(this).val())
              }), e.val(n), this.save()
          },
          updateSuggestion: function(t, e) {
              t = t.closest("[data-block=suggestion]"), e = _.reduce(e, function(t, e) {
                  return _.isEmpty(e) ? "" : t + (_.isEmpty(t) ? "" : ",") + ("-" === e.action ? "-" : "") + e.value
              }, "").trim();
              t.find("[data-suggest-value]").val(e).trigger("change")
          },
          suggestionLocked: function(t, e) {
              e = e.value, t = t.closest("[data-block=suggestion]").find("[data-suggest-value]").data("suggest-value");
              return this.controller.settings && this.controller.settings[t] && _.isBoolean(this.controller.settings[t].locked) && 1 == this.controller.settings[t].locked && _.isString(this.controller.settings[t].value) && 0 <= _.indexOf(this.controller.settings[t].value.replace("-", "").split(/\,/), "" + e)
          }
      }),
      n = Backbone.View.extend({
          ...
          showEditor: function(t) {
              if (t.preventDefault(), _.isObject(this.loop_editor_view)) return this.loop_editor_view.toggle(), !1;
              d.ajax({
                  type: "POST",
                  dataType: "json",
                  url: window.ajaxurl,
          ...
          createEditor: function(t) {
              this.loop_editor_view = new e({
                  model: _.isEmpty(t) ? {} : t
              }), this.loop_editor_view.render(this).show()
          },
          setInputValue: function(t) {
              this.$input.val(_.map(t, function(t, e) {
                  return e + ":" + t
              }).join("|"))
          }
      }),
      o = Backbone.View.extend({
          ...
          render: function() {
              var n = "";
              return _.each(this.settings, function(t) {
                  _.isUndefined(this.data[t.name]) ? _.isUndefined(t.value) || (t.value = t.value.toString().split(","), this.data[t.name] = t.value) : t.value = this.data[t.name], this.fields[t.name] = t;
                  var e = d("#vcl-options-field-" + t.type);
                  e.is("script") && (e = vc.template(e.html(), vc.templateOptions.custom), n += e(_.extend({}, {
                      name: "",
                      label: "",
                      value: [],
                      options: "",
          ...
          parseData: function() {
              _.each(this.$input.val().split("|"), function(t) {
                  var e;
                  t.match(/\:/) && (e = (t = t.split(":"))[0], this.data[e] = _.map(t[1].split(","), function(t) {
                      return window.decodeURIComponent(t)
                  }))
              }, this)
          },
          saveData: function() {
              var t = _.map(this.data, function(t, e) {
                  return e + ":" + _.map(t, function(t) {
          ...
          save: function(t) {
              var e, t = d(t.currentTarget);
              t.is(":checkbox") ? (e = [], this.$el.find("input[name=" + t.attr("name") + "]").each(function() {
                  this.checked && e.push(d(this).val())
              }), this.data[t.attr("name")] = e) : this.data[t.attr("name")] = [t.val()], this.saveData()
          }
      });

  function s(t) {
      this.el = t, this.$el = d(this.el), this.$data_field = this.$el.find(".wpb_vc_param_value"), this.$toolbar = this.$el.find(".vc_sorted-list-toolbar"), this.$current_control = this.$el.find(".vc_sorted-list-container"), _.defaults(this.options, {}), this.init()
  }
  s.prototype = {
      constructor: s,
      init: function() {
          ...
          var e, n = this.$data_field.val().split(",");
          for (e in n) {
              var a = n[e].split("|"),
      ...
      createControl: function(t) {
          var n = "",
              a = _.isUndefined(t.sub_value) ? [] : t.sub_value;
          _.isArray(t.sub) && _.each(t.sub, function(t, e) {
              n += " <select>", _.each(t, function(t) {
                  n += '<option value="' + t[0] + '"' + (_.isString(a[e]) && a[e] === t[0] ? ' selected="true"' : "") + ">" + t[1] + "</option>"
              }), n += "</select>"
          }, this), this.$current_control.append('<li class="vc_control-' + t.value + '" data-name="' + t.value + '">' + t.label + n + "</li>")
      },
      controlEvent: function(t) {
          t = d(t.currentTarget);
          t[0].checked ? this.createControl({
              value: t.val(),
              label: t.parent().text(),
              sub: t.data("subcontrol")
          }) : this.$current_control.find(".vc_control-" + t.val()).remove(), this.save()
      },
      save: function() {
          var t = _.map(this.$current_control.find("[data-name]"), function(t) {
              var e = encodeURIComponent(d(t).data("name"));
              return d(t).find("select").each(function() {
                  var t = d(this);
                  t.is("select") && "" !== t.val() && (e += "|" + encodeURIComponent(t.val()))
              }), e
          }).join(",");
          this.$data_field.val(t)
      }
  }, d.fn.VcSortedList = function(n) {
      return this.each(function() {
          var t = d(this),
              e = t.data("vc_sorted_list");
          e || t.data("vc_sorted_list", e = new s(this)), "string" == typeof n && e[n]()
      })
  };
  var r = Backbone.View.extend({
          ...
          fontStyleDropdownRender: function() {
              var t, e = this.font_types.split(","),
                  n = "",
                  a = this.$font_family_dropdown_el.attr("default[font_style]");
              for (t in e) var i = e[t].split(":"),
                  o = "",
                  n = n + "<option " + (o = _.isString(a) && 0 < a.length && e[t] == a ? "selected" : o) + ' value="' + e[t] + '" data[font_weight]="' + i[1] + '" data[font_style]="' + i[2] + '" class="' + i[2] + "_" + i[1] + '" >' + i[0] + "</option>";
          ...
          fontStyleDropdownChange: function() {
              var t = this.$font_style_dropdown_el.find(":selected");
              return this.font_weight = t.attr("data[font_weight]"), this.font_style = t.attr("data[font_style]"), this.previewElementRender(), this
          }
      }),
      l = Backbone.View.extend({
          ...
          initialize: function(t) {
              _.bindAll(this, "sortableChange", "resize", "labelRemoveHook", "updateItems", "sortableCreate", "sortableUpdate", "source", "select", "labelRemoveClick", "createBox", "focus", "response", "change", "close", "open", "create", "search", "_renderItem", "_renderMenu", "_renderItemData", "_resizeMenu"), t = d.extend({
                  min_length: this.min_length,
                  delay: this.delay,
                  auto_focus: this.auto_focus,
                  replace_values_on_select: this.replace_values_on_select
              }, t), this.options = t, this.param_name = this.options.param_name, this.$el = this.options.$el, this.$el_wrap = this.$el.parent(), this.$sortable_wrapper = this.$el_wrap.parent(), this.$input_param = this.options.$param_input, this.selected_items = [], this.isMultiple = !1, this.render()
          },
          resize: function() {
              var t = this.$el_wrap.position(),
                  e = this.$block.position();
              this.$el.autocomplete("widget").width(parseFloat(this.$block.width()) - (parseFloat(t.left) - parseFloat(e.left) + 4) + 11)
          },
          ...
          itemsCreate: function() {
              var n = [];
              this.$block.find(".vc_data").each(function(t, e) {
                  n.push({
          ...
          sortableUpdate: function() {
              var t = this.$sortable_wrapper.sortable("toArray", {
                      attribute: "data-index"
                  }),
                  e = [],
                  n = (_.each(t, function(t) {
                      e.push(this.selected_items[t])
                  }, this), 0);
              d("li.vc_data", this.$sortable_wrapper).each(function() {
                  d(this).attr("data-index", n++)
              }), this.selected_items = e, this.updateItems()
          },
          getWidget: function() {
          ...
          open: function() {
              var t = this.getWidget().menu(),
                  e = t.position();
              t.css("left", e.left - 6), t.css("top", e.top + 2)
          },
          focus: function(t) {
              if (!this.options.replace_values_on_select) return t.preventDefault(), !1
          },
          create: function() {},
          change: function() {},
          response: function() {},
          ...
          select: function(t, e) {
              var n, a, i;
              return this.selected = 1, e.item && (this.options.unique_values && (n = this.getWidget().data("uiMenu").active, this.options.groups && (a = n.prev(), i = n.next(), a.hasClass("vc_autocomplete-group")) && !i.hasClass("vc_autocomplete-item") && a.remove(), n.remove(), d("li.ui-menu-item", this.getWidget()).length || (this.selected = void 0)), this.createBox(e.item), this.isMultiple ? this.$el.trigger("focus") : this.$el.hide()), !1
          },
          createBox: function(t) {
              var e = this.selected_items.push(t) - 1;
              this.updateItems(), (e = d('<li class="vc_autocomplete-label vc_data" data-index="' + e + '" data-value="' + t.value + '" data-label="' + t.label + '"><span class="vc_autocomplete-label"><a>' + t.label + '</a></span><a class="vc_autocomplete-remove">&times;</a></li>')).insertBefore(this.$el_wrap), this.labelRemoveHook(e)
          },
          labelRemoveHook: function(t) {
              this.$el.blur(), this.$el.val(""), t.on("click", this.labelRemoveClick)
          },
          labelRemoveClick: function(t) {
              t.preventDefault();
              var e = d(t.currentTarget);
              if (d(t.target).is(".vc_autocomplete-remove")) return this.selected_items.splice(e.index(), 1), e.remove(), this.updateItems(), this.$el.show(), !1
          },
          getSelectedItems: function() {
              var e;
              return !!this.selected_items.length && (e = [], _.each(this.selected_items, function(t) {
                  e.push(t.value)
              }), e)
          },
          _renderMenu: function(n, t) {
              var a = this,
                  i = null;
              this.options.groups && t.sort(function(t, e) {
                  return t.group > e.group
              }), d.each(t, function(t, e) {
                  a.options.groups && e.group != i && (i = e.group, n.append('<li class="ui-autocomplete-group vc_autocomplete-group" aria-label="' + i + '">' + i + "</li>")), a._renderItemData(n, e)
              })
          },
          _renderItem: function(t, e) {
              return d('<li data-value="' + e.value + '" class="vc_autocomplete-item">').append("<a>" + e.label + "</a>").appendTo(t)
          },
          ...
          source: function(t, e) {
              var n = this;
              this.options.values && 0 < this.options.values.length ? this.options.unique_values ? e(d.ui.autocomplete.filter(_.difference(this.options.values, this.selected_items), t.term)) : e(d.ui.autocomplete.filter(this.options.values, t.term)) : d.ajax({
                  type: "POST",
                  dataType: "json",
                  url: this.ajax_url,
                  data: d.extend({
                      ...
                      query: t.term,
                      _vcnonce: window.vcAdminNonce
                  }, this.source_data(t, e))
              }).done(function(t) {
                  n.options.unique_values ? e(_.filter(t, function(t) {
                      return !_.findWhere(n.selected_items, t)
                  })) : e(t)
              })
          }
      }),
      c = Backbone.View.extend({
          ...
          render: function() {
              ...
              return d('[data-vc-ui-element="panel-shortcode-param"]', this.content()).each(function() {
                  var t = d(this),
                      e = t.data("param_settings");
                  vc.atts.init.call(n, e, t), t.data("vcInitParam", !0)
              }), this
          }
      }),
      p = Backbone.View.extend({
          ...
          initialize: function(t) {
              var e, n, a;
              this.$ul = this.$el.find("> .edit_form_line > .vc_param_group-list"), e = d("> .wpb_vc_row", this.$ul), this.initializer = new c({
                  el: this.$el
              }), this.model = vc.active_panel.model, n = this.$ul.data("settings"), this.mappedParams = {}, this.adminLabelParams = [], this.options = _.defaults({}, _.isObject(t.settings) ? t.settings : {}, n, this.options), this.groupParamName = this.options.param.param_name, _.isObject(this.options.param) && _.isArray(this.options.param.params) && _.each(this.options.param.params, function(t) {
                  var e = this.groupParamName + "_" + t.param_name;
                  this.mappedParams[e] = t, _.isObject(t) && !0 === t.admin_label && this.adminLabelParams.push(e)
              }, this), this.items = 0, a = this, e.length && e.each(function() {
                  e.data("vc-param-group-param", new u({
                      el: d(this),
                      parent: a
          ...
          afterDelete: function() {
              var t;
              this.addAllowed() && (this.$ul.find("> .wpb_vc_row > .vc_param_group-controls > .vc_row_edit_clone_delete > .vc_control.column_clone").show(), this.$ul.find("> .vc_param_group-add_content").show()), void 0 !== this.options.param.callbacks && void 0 !== this.options.param.callbacks.after_delete && "function" == typeof(t = window[this.options.param.callbacks.after_delete]) && t()
          }
      }),
      u = Backbone.View.extend({
          ...
          initialize: function(t) {
              this.options = t, this.$content = this.options.parent.$ul, this.model = vc.active_panel.model, this.mappedParams = this.options.parent.mappedParams, this.groupParamName = this.options.parent.groupParamName, this.adminLabelParams = this.options.parent.adminLabelParams, this.dependentElements = {}, _.bindAll(this, "hookDependent"), this.initializeDependency(), _.bindAll(this, "hookAdminLabel"), this.initializeAdminLabels()
          },
          initializeAdminLabels: function() {
              for (var e = this.hookAdminLabel, t = function() {
                      var t = d(this);
                      t.data("vc_admin_labels") || (t.data("vc_admin_labels", !0), t.on("keyup change", e), e({
                          currentTarget: this
                      }))
                  }, n = 0; n < this.adminLabelParams.length; n++) d("[name=" + this.adminLabelParams[n] + "].wpb_vc_param_value", this.$el).each(t)
          },
          hookAdminLabel: function(t) {
              for (var e = "", n = "", a = [], i = (s = d(t.currentTarget)).closest(".vc_param_group-wrapper"), t = s.closest(".vc_param").find(".vc_param-group-admin-labels"), o = 0; o < this.adminLabelParams.length; o++) {
                  var s, r = this.adminLabelParams[o],
                      l = (s = i.find("[name=" + r + "]")).closest('[data-vc-ui-element="panel-shortcode-param"]');
                  void 0 !== this.mappedParams[r] && (e = this.mappedParams[r].heading), n = s.is("select") ? s.find("option:selected").text() : !s.is("input:checkbox") || s[0].checked ? s.val() : "", r = {
                      type: l.data("param_type"),
                      param_name: l.data("param_name")
                  }, "" !== (n = _.isObject(vc.atts[r.type]) && _.isFunction(vc.atts[r.type].render) ? vc.atts[r.type].render.call(this, r, n) : n) && a.push("<label>" + _.escape(e) + "</label>: " + _.escape(n))
              }
              t.html(a.join(", ")).toggleClass("vc_hidden-label", !a.length)
          },
          initializeDependency: function() {
              var o = {};
              _.each(this.mappedParams, function(a, t) {
                  var e, i;
                  _.isObject(a) && _.isObject(a.dependency) && _.isString(a.dependency.element) && (e = d("[name=" + this.groupParamName + "_" + a.dependency.element + "].wpb_vc_param_value", this.$el), (i = d("[name=" + t + "].wpb_vc_param_value", this.$el)).length) && _.each(e, function(t) {
                      var t = d(t),
                          e = t.attr("name"),
                          n = a.dependency;
                      _.isArray(this.dependentElements[e]) || (this.dependentElements[e] = []), this.dependentElements[e].push(i), t.data("dependentSet") || (t.attr("data-dependent-set", "true"), t.on("keyup change", this.hookDependent)), o[e] || (o[e] = t), _.isString(n.callback) && window[n.callback].call(this)
                  }, this)
              }, this), _.each(o, function(t) {
                  this.hookDependent({
                      currentTarget: t
                  })
              }, this)
          },
          hookDependent: function(t) {
              var t = d(t.currentTarget),
                  e = t.closest(".vc_column"),
                  n = this.dependentElements[t.attr("name")],
                  a = t.is(":checkbox") ? _.map(this.$el.find("[name=" + t.attr("name") + "].wpb_vc_param_value:checked"), function(t) {
                      return d(t).val()
                  }) : t.val(),
                  i = t.is(":checkbox") ? !this.$el.find("[name=" + t.attr("name") + "].wpb_vc_param_value:checked").length : !a.length;
              return e.hasClass("vc_dependent-hidden") ? _.each(n, function(t) {
                  var e = d.Event("change");
                  e.extra_type = "vcHookDependedParamGroup", t.closest(".vc_column").addClass("vc_dependent-hidden"), t.trigger(e)
              }) : _.each(n, function(t) {
                  var e = t.attr("name"),
                      e = _.isObject(this.mappedParams[e]) && _.isObject(this.mappedParams[e].dependency) ? this.mappedParams[e].dependency : {},
                      n = t.closest(".vc_column");
                  _.isBoolean(e.not_empty) && !0 === e.not_empty && !i || _.isBoolean(e.is_empty) && !0 === e.is_empty && i || e.value && _.intersection(_.isArray(e.value) ? e.value : [e.value], _.isArray(a) ? a : [a]).length || e.value_not_equal_to && !_.intersection(_.isArray(e.value_not_equal_to) ? e.value_not_equal_to : [e.value_not_equal_to], _.isArray(a) ? a : [a]).length || e.value_includes && a.includes(e.value_includes) ? n.removeClass("vc_dependent-hidden") : n.addClass("vc_dependent-hidden"), (e = d.Event("change")).extra_type = "vcHookDependedParamGroup", t.trigger(e)
              }, this), this
          },
          deleteParam: function(t) {
              t && t.preventDefault && t.preventDefault(), !0 === confirm(window.i18nLocale.press_ok_to_delete_section) && (this.options.parent.items--, this.options.parent.afterDelete(), this.$el.remove(), this.unbind(), this.remove())
          },
          content: function() {
              return this.$content
          },
          clone: function(t) {
              var e, n;
              t.preventDefault(), this.options.parent.addAllowed() && (t = this.options.parent.$ul.data("settings"), e = this.$content, this.$content = this.$el, n = vc.atts.param_group.parseOne.call(this, t), d.ajax({
                  type: "POST",
                  url: window.ajaxurl,
                  data: {
                      action: "vc_param_group_clone",
                      param: a(JSON.stringify(t)),
                      shortcode: vc.active_panel.model.get("shortcode"),
                      value: n,
                      vc_inline: !0,
                      _vcnonce: window.vcAdminNonce
                  ...
                  t = t.data || "", t = d(t);
                  t.insertAfter(this.$el), this.$content = e, this.options.parent.initializer.$content = d("> .wpb_element_wrapper", t), this.options.parent.initializer.render(), t.data("vc-param-group-param", new u({
                      el: t,
                      parent: this.options.parent
                  })), this.options.parent.items++, this.options.parent.afterAdd(t, "clone")
              }))
          },
          toggle: function(t) {
              t.preventDefault();
              t = this.$el;
              t.find("> .wpb_element_wrapper").slideToggle(), t.toggleClass("vc_param_group-collapsed").siblings(":not(.vc_param_group-collapsed)").addClass("vc_param_group-collapsed").find("> .wpb_element_wrapper").slideUp()
          }
      }),
      h = (vc.edit_form_callbacks = [], vc.atts = {
          parse: function(t) {
              var e = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"),
                  n = e.closest('[data-vc-ui-element="panel-shortcode-param"]'),
                  n = _.isUndefined(vc.atts[t.type]) || _.isUndefined(vc.atts[t.type].parse) ? e.length ? e.val() : null : n.data("vcInitParam") ? vc.atts[t.type].parse.call(this, t) : (n = this.model.get("params"), _.isUndefined(n[t.param_name]) ? e.length ? e.val() : null : n[t.param_name]);
              return void 0 !== e.data("js-function") && void 0 !== window[e.data("js-function")] && (0, window[e.data("js-function")])(this.$el, this, t), n
          },
          parseFrame: function(t) {
              return vc.atts.parse.call(this, t)
          },
          parseText: function(t) {
              var t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"),
                  e = t.val(),
                  t = t.attr("data-value-type");
              try {
                  t && "text" === t && (e = window.vc.utils.stripHtmlTags(e)), e = window.vc.utils.fixUnclosedTags(e)
              } catch (t) {
                  console.error("Failed to execute window.vc.utils functions during param parse: ", t)
              }
              return e
          },
          init: function(t, e) {
              _.isUndefined(vc.atts[t.type]) || _.isUndefined(vc.atts[t.type].init) || vc.atts[t.type].init.call(this, t, e)
          }
          ...
          parse: function(e) {
              ...
              try {
                  t.tinyMCE && _.isArray(t.tinyMCE.editors) && _.each(t.tinyMCE.editors, function(t) {
                      "wpb_tinymce_content" === t.id && t.save()
                  })
              } catch (t) {
                  window.console && window.console.warn && window.console.warn("textarea_html atts parse error", t)
              }
              try {
                  n = window.vc.utils.validateHtml(e.val())
              } catch (t) {
                  console.error("Error validating HTML content: ", t), n = e.val()
              }
              return n
          },
          render: function(t, e) {
              return _.isUndefined(e) ? e : vc_wpautop(e)
          }
      }, vc.atts.textfield = {
          parse: function(t) {
              return vc.atts.parseText.call(this, t)
          }
      }, vc.atts.textarea = {
          parse: function(t) {
              return vc.atts.parseText.call(this, t)
          ...
          parse: function(t) {
              t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]").val();
              return t.match(/"|(http)/) ? "#E-8_" + base64_encode(rawurlencode(t)) : t
          },
          render: function(t, e) {
              return e && e.match(/^#E\-8_/) ? d("<div/>").text(rawurldecode(base64_decode(e.replace(/^#E\-8_/, "")))).html() : e
          }
      }, vc.atts.checkbox = {
          parse: function(t) {
              var e = [],
                  n = "";
              return d("input[name=" + t.param_name + "]", this.content()).each(function() {
                  var t = d(this);
                  this.checked && e.push(t.attr("value"))
              }), n = 0 < e.length ? e.join(",") : n
          },
          defaults: function() {
              return ""
          }
          ...
          clone: function(t, e, n) {
              var a = t.get("params");
              _.isUndefined(n) || _.isUndefined(n.settings) || _.isUndefined(n.settings.auto_generate) || !0 !== n.settings.auto_generate ? a[n.param_name] = "" : a[n.param_name] = Date.now() + "-" + vc_guid(), t.set({
                  params: a
              }, {
                  silent: !0
              })
          ...
          create: function(t, e, n) {
              if (t.get("cloned")) return vc.atts.el_id.clone(t, e, n);
              !_.isEmpty(e) || _.isUndefined(n) || _.isUndefined(n.settings) || _.isUndefined(n.settings.auto_generate) || 1 != n.settings.auto_generate || ((e = t.get("params"))[n.param_name] = Date.now() + "-" + vc_guid(), t.set({
                  params: e
              }, {
                  silent: !0
              }))
          ...
          parse: function(t) {
              return this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]").val().replace(/\n/g, ",")
          }
      }, vc.atts.exploded_textarea_safe = {
          parse: function(t) {
              t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]").val();
              return (t = t.replace(/\n/g, ",")).match(/"|(http)/) ? "#E-8_" + base64_encode(rawurlencode(t)) : t
          },
          render: function(t, e) {
              return e && e.match(/^#E\-8_/) ? d("<div/>").text(rawurldecode(base64_decode(e.replace(/^#E\-8_/, "")))).html() : e
          }
          ...
          parse: function(t) {
              t = vc.atts.parseText.call(this, t);
              return base64_encode(rawurlencode(t))
          },
          render: function(t, e) {
              var n = window.vc.utils.isBase64(e) ? rawurldecode(base64_decode(e.trim())) : e;
              return e ? d("<div/>").text(n).html() : ""
          }
      }, vc.atts.textarea_ace = {
          init: function(t, e) {
              var n, a = e.find(".textarea_ace_container"),
                  i = e.find('input.wpb_vc_param_value[name="content"]'),
                  e = a.attr("id");
              "undefined" != typeof ace ? ((n = ace.edit(e)).setTheme("ace/theme/chrome"), a = t.mode || "html", n.session.setMode("ace/mode/" + a), n.session.setOption("wrap", "free"), a = "", i.val() && (a = rawurldecode(base64_decode(i.val()))), n.setValue(a, -1), n.clearSelection(), n.getSession().on("change", function() {
                  var t = n.getValue();
                  try {
                      t = window.vc.utils.fixUnclosedTags(t)
                  } catch (t) {
                      console.error("Failed to execute window.vc.utils.fixUnclosedTags function: ", t)
                  }
                  t = base64_encode(rawurlencode(t));
                  i.val(t)
          ...
          render: function(t, e) {
              e = e ? rawurldecode(base64_decode(e.trim())) : "";
              return e ? d("<div/>").text(e).html() : ""
          }
      }, vc.atts.dropdown = {
          render: function(t, e) {
              return e
          ...
          init: function(t, e) {
              d(".wpb_vc_param_value.dropdown", e).on("change", function() {
                  var t = d(this),
                      e = t.find(":selected"),
                      n = t.data("option"),
                      e = e.length ? e.attr("class").replace(/\s/g, "_") : "";
                  e = e.replace("#", "hash-"), void 0 !== n && t.removeClass(n), void 0 !== e && (t.data("option", e), t.addClass(e))
              })
          },
          defaults: function(t) {
              var e;
              return _.isArray(t.value) || _.isString(t.value) ? _.isArray(t.value) ? (e = t.value[0], _.isArray(e) && e.length ? e[0] : e) : "" : (e = _.values(t.value)[0]).label ? e.value : e
          }
      }, vc.atts.href = {
          parse: function(t) {
              var t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"),
                  e = "";
              return e = t.length && "http://" !== t.val() ? t.val() : e
          }
      },
    ...
    // nectar addition end
      vc.atts.attach_image = {
          ...
          parse: function(t) {
              var e = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"),
                  n = "";
              return e.parent().find("li.added").length && (n = e.parent().find("li.added img").attr("src")), d("[data-model-id=" + this.model.id + "]").data("field-" + t.param_name + "-attach-image", n), vc.atts.attach_image.isParse = !0, e.length ? e.val() : null
          },
          render: function(t, e) {
              var n = d("[data-model-id=" + this.model.id + "]"),
                  a = n.data("field-" + t.param_name + "-attach-image"),
                  i = this.$el.find(".attachment-thumbnail[data-name=" + t.param_name + "]"),
                  o = {
                      image_src: "",
                      image_alt: ""
                  };
              return "image" === t.param_name && ("external_link" === this.model.getParam("source") ? (o.image_src = this.model.getParam("custom_src"), vc.atts.attach_image.updateImage(i, o)) : _.isEmpty(e) && "featured_image" !== this.model.getParam("source") ? _.isUndefined(a) || (n.removeData("field-" + t.param_name + "-attach-image"), o.image_src = a, vc.atts.attach_image.updateImage(i, o)) : (f("get_attach_image", t, e, this.model), vc.atts.attach_image.isParse && d.ajax({
                  type: "POST",
                  url: window.ajaxurl,
                  data: {
                      action: "wpb_single_image_data",
                  ...
                  var e;
                  t.success && (e = t.data.image_src.length || "featured_image" === this.model.getParam("source"), vc.atts.attach_image.updateImage(i, t.data, e))
              }))), e
          },
          updateImage: function(t, e, n) {
              var a = e.image_src,
                  e = e.image_alt;
              t.length && ((n = void 0 === n ? !1 : n) || !_.isEmpty(a) ? (t.attr("src", a), t.attr("alt", e), (_.isEmpty(a) ? (t.hide(), t.next().removeClass("image-exists")) : (t.show(), t.next().addClass("image-exists"))).next().addClass("image-exists")) : t.attr("src", "").hide().next().removeClass("image-exists").next().removeClass("image-exists"))
          }
          ...
          parse: function(t) {
              var e = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]"),
                  n = "";
              return e.parent().find("li.added").each(function() {
                  n += '<li><img src="' + d(this).find("img").attr("src") + '" alt=""></li>'
              }), d("[data-model-id=" + this.model.id + "]").data("field-" + t.param_name + "-attach-images", n), vc.atts.attach_images.isParse = !0, e.length ? e.val() : null
          },
          render: function(t, e) {
              var n = this.$el.find(".attachment-thumbnails[data-name=" + t.param_name + "]");
              return "external_link" === this.model.getParam("source") && (e = this.model.getParam("custom_srcs")), _.isEmpty(e) ? (this.$el.removeData("field-" + t.param_name + "-attach-images"), vc.atts.attach_images.updateImages(n, "")) : (f("get_gallery_images", t, e, this.model), vc.atts.attach_images.isParse && d.ajax({
                  type: "POST",
                  url: window.ajaxurl,
                  data: {
          ...
          updateImages: function(t, e) {
              t.html(e), e.length ? t.removeClass("image-exists").next().addClass("image-exists") : t.addClass("image-exists").next().removeClass("image-exists")
          }
      }, vc.atts.google_fonts = {
          parse: function(t) {
              var t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]").parent(),
                  e = {};
              return e.font_family = t.find(".vc_google_fonts_form_field-font_family-select > option:selected").val(), e.font_style = t.find(".vc_google_fonts_form_field-font_style-select > option:selected").val(), e.font_vendor = t.find(".vc_google_fonts_form_field-font_family-select > option:selected").attr("data[font_vendor]"), t = _.map(e, function(t, e) {
                  if (_.isString(t) && 0 < t.length) return e + ":" + encodeURIComponent(t)
              }), d.grep(t, function(t) {
                  return _.isString(t) && 0 < t.length
              }).join("|")
          },
          init: function(t, e) {
              var n = e;
              n.length && ("undefined" != typeof WebFont ? e.data("vc-param-object", new r({
                  el: n
          ...
          parse: function(t) {
              var t = this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]").parent(),
                  e = {};
              return e.tag = t.find(".vc_font_container_form_field-tag-select > option:selected").val(), e.font_size = t.find(".vc_font_container_form_field-font_size-input").val(), e.text_align = t.find(".vc_font_container_form_field-text_align-select > option:selected").val(), e.font_family = t.find(".vc_font_container_form_field-font_family-select > option:selected").val(), e.color = t.find(".vc_font_container_form_field-color-input").val(), e.line_height = t.find(".vc_font_container_form_field-line_height-input").val(), e.font_style_italic = t.find(".vc_font_container_form_field-font_style-checkbox.italic").prop("checked") ? "1" : "", e.font_style_bold = t.find(".vc_font_container_form_field-font_style-checkbox.bold").prop("checked") ? "1" : "", t = _.map(e, function(t, e) {
                  if (_.isString(t) && 0 < t.length) return e + ":" + encodeURIComponent(t)
              }), d.grep(t, function(t) {
                  return _.isString(t) && 0 < t.length
              }).join("|")
          ...
          init: function(t, e) {
              vc.atts.colorpicker.init.call(this, t, e)
          }
      }, vc.atts.param_group = {
          parse: function(t) {
              var e = this.content(),
                  n = e.find('.wpb_el_type_param_group[data-vc-ui-element="panel-shortcode-param"][data-vc-shortcode-param-name="' + t.param_name + '"]').find("> .edit_form_line > .vc_param_group-list"),
                  t = vc.atts.param_group.extractValues.call(this, t, d('>.wpb_vc_row:not(".vc_param_group-add_content-wrapper")', n));
              return this.$content = e, encodeURIComponent(JSON.stringify(t))
          },
          extractValues: function(i, t) {
              var e = [],
                  o = this;
              return t.each(function() {
                  var a = {};
                  o.$content = d(this), _.each(i.params, function(t) {
                      var e, t = d.extend({}, t),
                          n = t.param_name;
                      t.param_name = i.param_name + "_" + n, ((e = vc.atts.parse.call(o, t)).length || t.save_always) && (a[n] = e)
                  }), e.push(a)
              }), e
          },
          parseOne: function(t) {
              var e = this.content(),
                  t = vc.atts.param_group.extractValues.call(this, t, e);
              return this.$content = e, a(JSON.stringify(t))
          },
          init: function(t, e) {
              e.data("vc-param-object", new p({
                  el: e,
                  settings: {
                      param: t
                  }
          ...
          init: function(t, e) {
              e.length && e.each(function() {
                  var t = d(".wpb_vc_param_value", this),
                      e = t.attr("name"),
          ...
          init: function(t, e) {
              d(".vc_link-build", e).on("click", function(t) {
                  ...
                  var i, o, s, r, l, e, c, n = function(t, e) {
                          jQuery(e).addClass("vc-link-wrapper");
                          var a = d("#wp-link-cancel button");
                          l.off("click.vcLink").on("click.vcLink", function(t) {
                              t && t.preventDefault && t.preventDefault(), t && t.stopImmediatePropagation && t.stopImmediatePropagation(), (t = {}).url = (d("#wp-link-url").length ? d("#wp-link-url") : d("#url-field")).val(), t.title = (d("#wp-link-text").length ? d("#wp-link-text") : d("#link-title-field")).val();
                              var e, n = d("#wp-link-target").length ? d("#wp-link-target") : d("#link-target-checkbox");
                              return t.target = n[0].checked ? "_blank" : "", t.rel = d("#vc-link-nofollow")[0].checked ? "nofollow" : "", e = _.map(t, function(t, e) {
                                  if (_.isString(t) && 0 < t.length) return e + ":" + encodeURIComponent(t).trim()
                              }).filter(function(t) {
                                  return t
                              }).join("|"), i.val(e).trigger("change"), i.data("json", t), o.html(t.url + t.target), s.html(t.title), c.close("noReset"), r.show(), l.off("click.vcLink"), l.remove(), a.off("click.vcLinkCancel"), window.wpLink.textarea = "", n.attr("checked", !1), d("#most-recent-results").css("top", ""), d("#vc-link-nofollow").attr("checked", !1), !1
                          }), a.off("click").on("click.vcLinkCancel", function(t) {
                              t && t.preventDefault && t.preventDefault(), t && t.stopImmediatePropagation && t.stopImmediatePropagation(), c.close("noReset"), l.off("click.vcLink"), l.remove(), a.off("click.vcLinkCancel"), window.wpLink.textarea = ""
                          })
                      },
                      a = function(t, e) {
                          jQuery(e).removeClass("vc-link-wrapper"), jQuery(document).off("wplink-open", n), jQuery(document).off("wplink-close", a)
                      };
                  jQuery(document).off("wplink-open", n).on("wplink-open", n), jQuery(document).off("wplink-close", a).on("wplink-close", a), "admin_frontend_editor" === vc_mode ? c.open("vc-hidden-editor") : c.open("content"), _.isString(t.url) && (d("#wp-link-url").length ? d("#wp-link-url") : d("#url-field")).val(t.url), _.isString(t.title) && (d("#wp-link-text").length ? d("#wp-link-text") : d("#link-title-field")).val(t.title), (d("#wp-link-target").length ? d("#wp-link-target") : d("#link-target-checkbox")).prop("checked", !_.isEmpty(t.target)), d("#vc-link-nofollow").length && d("#vc-link-nofollow").prop("checked", !_.isEmpty(t.rel))
              })
          }
      }, vc.atts.sorted_list = {
          init: function(t, e) {
              d(".vc_sorted-list", e).VcSortedList()
          }
      }, vc.atts.options = {
          init: function(t, e) {
              e.data("vc-param-object", new o({
                  el: e
              }))
          }
      }, vc.atts.iconpicker = {
          change: function(t, e) {
              e = e.find(".vc-iconpicker");
              e.val(this.value), e.data("vc-no-check", !0), e.find('[value="' + this.value + '"]').attr("selected", "selected"), e.data("vcFontIconPicker").loadIcons()
          },
          parse: function(t) {
              return this.content().find(".wpb_vc_param_value[name=" + t.param_name + "]").parent().find(".vc-iconpicker").val()
          },
          init: function(t, e) {
              var n = e.find(".wpb_vc_param_value"),
                  a = d.extend({
                      iconsPerPage: 100,
              ...
              e.find(".vc-iconpicker").vcFontIconPicker(a).on("change", function() {
                  var t = d(this);
                  t.data("vc-no-check") || n.data("vc-no-check", !0).val(this.value).trigger("change"), t.data("vc-no-check", !1)
              }), n.on("change", function() {
                  n.data("vc-no-check") || vc.atts.iconpicker.change.call(this, t, e), n.data("vc-no-check", !1)
              })
          }
      }, vc.atts.animation_style = {
          init: function(t, e) {
              var n = e,
                  a = d(".wpb_vc_param_value[name=" + t.param_name + "]", n);

              function i(t, e) {
                  d(t).removeClass().addClass(e + " animated").one("webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend", function() {
                      d(this).removeClass().addClass("vc_param-animation-style-preview")
                  })
              }
              d('option[value="' + a.val() + '"]', n).attr("selected", !0), d(".vc_param-animation-style-trigger", n).on("click", function(t) {
                  t.preventDefault();
                  t = d(".vc_param-animation-style", n).val();
                  "none" !== t && i(this.parentNode, "vc_param-animation-style-preview " + t)
              }), d(".vc_param-animation-style", n).on("change", function() {
                  var t = d(this).val();
                  a.val(t), "none" !== t && i(d(".vc_param-animation-style-preview", n), "vc_param-animation-style-preview " + t)
              })
          }
      }, vc.atts.gutenberg = {
          content: null,
          ...
          closeEditor: function(t) {
              ...
              var e = this;
              _.delay(function() {
                  e.content.find(".vc_gutenberg-modal-wrapper").html(""), e.$frame = null, e.gutenbergParamObj = null
              }, 100)
          },
          updateEditor: function(t) {
              t && t.preventDefault && t.preventDefault(), this.gutenbergParamObj && this.gutenbergParamObj.updateValueFromIframe(), this.closeEditor()
          },
          init: function(t, e) {
              var n = vc.atts.gutenberg,
                  a = (n.content = e, d(".wpb_vc_param_value[name=" + t.param_name + "]", n.content));
              d('[data-vc-action="open"]', n.content).on("click", function(t) {
                  t.preventDefault();
                  var t = a.val(),
                      e = window.wpbGutenbergEditorUrl || "/wp-admin/post-new.php?post_type=wpb_gutenberg_param";
      ...
      m = function() {
          var t = window.i18nLocale.gutenbergEditorUpdateButton || "Update";
          return '<div class="wpb-gutenberg-controls-container">' + h() + '<button class="vc_gutenberg-modal-update-button">' + t + '</button><button class="wpb-gutenberg-modal-close-button"><i class="vc-composer-icon vc-c-icon-close"></i></button></div>'
      },
      v = function(t) {
          return this.iframe = null, this.options = t || {}, this.value = this.options && this.options.value ? this.options.value : "", this.iframeLoaded = function() {
              var e = !!this.iframe.contentWindow.wp && this.iframe.contentWindow.wp.data,
                  n = (e || (t = (t = window.i18nLocale || !1) && t.gutenbergDoesntWorkProperly ? t.gutenbergDoesntWorkProperly : "Gutenberg plugin doesn't work properly. Please check Gutenberg plugin.", window.alert(t), this.options && this.options.onError && this.options.onError()), parseInt(this.iframe.contentWindow.document.getElementById("post_ID").value)),
                  a = {
                      id: n,
                      guid: {
                          raw: "/?",
                  ...
                  i = e.dispatch("core/editor"),
                  t = e.select("core/edit-post"),
                  ...
                  r = (o && o.classList.add("hidden"), s && s.classList.add("hidden"), t.isPublishSidebarOpened = function() {
                      return !0
                  }, "function" == typeof i.autosave && (i.autosave = function() {}), this.value),
                  l = !1,
                  c = (e.subscribe(function() {
                      var t = e.select("core/editor").getCurrentPost();
                      !l && t && t.id === n && (l = !0, i.setupEditor(a, {
                          content: r
                      }))
                  }), this.iframe);
              setTimeout(function() {
                  var t, e, n;
                  t = d(t = c).contents(), e = t.find(".edit-post-header-toolbar"), n = m(), d(n).insertAfter(e), t.find(".vc_gutenberg-modal-update-button, .wpb-gutenberg-modal-close-button").on("click", function() {
                      setTimeout(function() {
                          window.sessionStorage.removeItem("wp-autosave-block-editor-post-auto-draft")
                      }, "3000")
                  }), n = vc.atts.gutenberg, t.find(".wpb-gutenberg-modal-close-button").on("click", n.closeEditor.bind(n)), t.find(".vc_gutenberg-modal-update-button").on("click", n.updateEditor.bind(n))
              }, "3000")
          }, this.updateValueFromIframe = function() {
              var t;
              this.iframe && this.iframe.contentWindow && this.iframe.contentWindow.wp && this.iframe.contentWindow.wp.data && (t = this.iframe.contentWindow.wp.data) && (t = t.select("core/editor").getEditedPostContent(), this.setValue(t))
          }, this.setValue = function(t) {
              this.value = t, this.options.onSetValue && this.options.onSetValue(t)
          }, this
      };
  ...
  }, vc.atts.addShortcodeIdParam = function(e) {
      var n = !1,
          a = e.get("params"),
          t = vc.map[e.get("shortcode")];
      _.isArray(t.params) && _.each(t.params, function(t) {
          t && !_.isUndefined(t.type) && ("tab_id" === t.type && _.isEmpty(a[t.param_name]) ? (n = !0, a[t.param_name] = vc_guid() + "-" + Math.floor(11 * Math.random())) : "vc_grid_id" === t.type && (n = !0, a[t.param_name] = vc.atts.vc_grid_id.parse.call({
              model: e
          })))
      }), n && e.save("params", a, {
          silent: !0
      })
  }, vc.getMapped = vc.memoizeWrapper(function(t) {
      return vc.map[t] || {}
  })
})(window.jQuery);
(n => {
...
(() => {
  ...
  vc.shortcode = Backbone.Model.extend({
      ...
      sync: function(e, t, n) {
          ...
          a ? n.success(a) : n.error("Record not found")
      },
      getParam: function(e) {
      ...
      createShortcodeString: function(e, t) {
          var n, a = e.get("shortcode"),
              r = _.extend({}, e.get("params")),
              i = {},
              r = vc.getMergedParams(a, r);
          return _.each(r, function(e, t) {
              i[t] = vc.storage.escapeParam(e)
          }, this), r = vc.getMapped(a), r = _.isObject(r) && (_.isBoolean(r.is_container) && !0 === r.is_container || !_.isEmpty(r.as_parent)), n = this._getShortcodeContent(e, t), n = {
              tag: a,
              attrs: i,
              content: n,
              type: _.isUndefined(vc.getParamSettings(a, "content")) && !r ? "single" : ""
...
(a => {
  vc.clone_index = 1, vc.shortcode_view = Backbone.View.extend({
      ...
      events: {
          ...
          "touchstart .column_delete,.vc_control-btn-delete": "deleteShortcode",
          "click .column_add,.vc_control-btn-prepend": "addElement",
          "touchstart .column_add,.vc_control-btn-prepend": "addElement",
          "click .column_edit,.vc_control-btn-edit, .column_edit_trigger": "editElement",
          "touchstart .column_edit,.vc_control-btn-edit, .column_edit_trigger": "editElement",
          "click .column_clone,.vc_control-btn-clone": "clone",
          "touchstart .column_clone,.vc_control-btn-clone": "clone",
          "click .column_copy,.vc_control-btn-copy": "copy",
          "touchstart .column_copy,.vc_control-btn-copy": "copy",
          "click .column_paste,.vc_control-btn-paste": "paste",
          "touchstart .column_paste,.vc_control-btn-paste": "paste",
      ...
      changeShortcodeParams: function(e) {
          ...
          _.defer(function() {
              ...
              _.isObject(vc.atts[e.type]) && _.isFunction(vc.atts[e.type].render) && (o = vc.atts[e.type].render.call(this, e, o)), i.children("." + e.param_name).is("input,textarea,select") ? i.children("[name=" + e.param_name + "]").val(o) : i.children("." + e.param_name).is("iframe") ? i.children("[name=" + e.param_name + "]").attr("src", o) : i.children("." + e.param_name).is("img") ? (t = i.children("[name=" + e.param_name + "]"), o && o.match(/^\d+$/) ? a.ajax({
                  ...
                  t.attr("src", e)
            // nectar addition -- added sanitizeTags to vc_wpautop. TODO: check if label value needs it, as _.escape is being used
              }) : o && t.attr("src", o)) : i.children("[name=" + e.param_name + "]").html(o ? vc_wpautop(this.sanitizeTags(o)) : ""), c.length && ("" === o || _.isUndefined(o) ? c.hide().addClass("hidden-label") : (_.isObject(e.value) && !_.isArray(e.value) && "checkbox" === e.type ? (n = _.invert(e.value), r = _.map(o.split(/[\s]*\,[\s]*/), function(e) {
                  return _.isString(n[e]) ? n[e] : e
              }).join(", ")) : _.isObject(e.value) && !_.isArray(e.value) && (n = _.invert(e.value), r = _.isString(n[o]) ? n[o] : o), c.html("<label>" + c.find("label").text() + "</label>: " + this.sanitizeTags(r)), c.show().removeClass("hidden-label")))
...
(r => {
  vc.saved_custom_css = !1, vc.createPreLoader = function() {
      ...
      events: {
          ...
          "dragover .metabox-composer-content": "handleDragOver",
          "dragleave .metabox-composer-content": "handleDragLeave",
          "drop .metabox-composer-content": "handleDrop",
          "touchstart .wpb_column_container .wpb_content_element": "handleTouchStart"
      },
      ...
      addShortcode: function(e) {
          var t, s = _.extend(vc.getDefaults(e.get("shortcode")), e.get("params")),
              n = (e.set("params", s, {
                  silent: !0
              }), t = this.getView(e), s = !1 !== e.get("parent_id") && this.views[e.get("parent_id")], t.use_default_content = !0 !== e.get("cloned"), this.views[e.id] = t, this);
          s ? (s.addShortcode(t), s.checkIsEmpty(), _.defer(function() {
              t.changeShortcodeParams && t.changeShortcodeParams(e), t.ready(), t.checkIsEmpty(), n.setSortable(), n.setNotEmpty()
          })) : (this.addRow(t), _.defer(function() {
              t.changeShortcodeParams && t.changeShortcodeParams(e), t.ready(), t.checkIsEmpty(), "vc_section" === t.model.get("shortcode") && n.setNotEmpty()
          }))
      },
      addRow: function(e) {
      ...
      sortingStarted: function() {
          r("#wpbakery_content").addClass("vc_sorting-started")
      },
      sortingStopped: function(e, t) {
          var s = t.item.data("element_type"),
              n = t.placeholder.closest("[data-element_type]").data("element_type") || "";
          vc.check_relevance(n, s) && n != s || (t.placeholder.addClass("vc_hidden-placeholder"), r(e.target).sortable("cancel")), r("#wpbakery_content").removeClass("vc_sorting-started")
      },
      updateElementsSorting: function(e, a) {
          _.defer(function(e) {
              var t, s = a.item.parent().closest("[data-model-id]").data("model"),
                  n = a.item.data("model"),
                  o = e.views[s.id].$content.find("> [data-model-id]"),
                  c = 0;
              _.isNull(a.sender) || (t = n.get("parent_id"), vc.storage.lock(), n.save({
                  parent_id: s.id
              }), t && e.views[t].checkIsEmpty(), e.views[s.id].checkIsEmpty()), o.each(function() {
      ...
      updateRowsSorting: function(a, i) {
          _.defer(function(e) {
              var t = i.item.parent(),
                  ...
                  n = i.item.data("model"),
                  o = i.item.data("element_type"),
                  c = i.item.parent().closest("[data-element_type]").data("element_type") || "";
              vc.check_relevance(c, o) && c != o ? (c = n.get("parent_id"), t.find(e.rowSortableSelector).each(function() {
                  var e = r(this).index();
                  ...
                  parent_id: s
              }), c && e.views[c].checkIsEmpty(), s && e.views[s].checkIsEmpty()) : r(a.target).sortable("cancel")
          }, this)
      },
      ...
      setSortable: function() {
          if (vc_user_access().partAccess("dragndrop")) return r(".wpb_main_sortable").sortable({
              ...
              over: function(e, t) {
                  var s = t.item.data("element_type"),
                      n = t.placeholder.closest("[data-element_type]").data("element_type") || "";
                  if (!vc.check_relevance(n, s) || n == s) return t.placeholder.addClass("vc_hidden-placeholder"), !1;
                  t.placeholder.css({
              ...
              stop: function(e, t) {
                  ...
                  var s = t.item.data("element_type"),
                      n = t.item.parent().closest("[data-element_type]").data("element_type") || "",
                      o = !!_.isUndefined(vc.map[n].allowed_container_element) || vc.map[n].allowed_container_element;
                  vc.check_relevance(n, s) && n != s || r(this).sortable("cancel"), _.isObject(vc.map[s]) && (_.isBoolean(vc.map[s].is_container) && !0 === vc.map[s].is_container || !_.isEmpty(vc.map[s].as_parent)) && !0 !== o && o !== t.item.data("element_type").replace(/_inner$/, "") && r(this).sortable("cancel"), r(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
              },
      ...
      show: function() {
          ...
          })), this.switchEditorsUrlParams("classic-editor", "wpb-backend-editor")
      },
      close: function() {
          ...
          }), this.switchEditorsUrlParams("wpb-backend-editor", "classic-editor")
      },
      switchEditorsUrlParams: function(e, t) {
          var s = new URL(window.location.href),
              e = (s.searchParams.delete(e), s.href.replace(/#$/, ""));
          s.searchParams.has(t) || (-1 === e.indexOf("?") ? window.history.replaceState(null, "", e + "?" + t) : window.history.replaceState(null, "", e + "&" + t))
      },
      ...
      save: function() {
        ...
        /* nectar addition */
        jQuery("#wpb-save-post p").text(window.i18nLocale.loading);
      ...
      processScroll: function() {
          var e;
          !0 === this.disableFixedNav ? this.$nav.removeClass("vc_subnav-fixed") : ((!this.navTop || this.navTop < 0) && this.setNavTop(), this.scrollTop = parseInt(r(window).scrollTop() - 10), 0 < this.navTop && this.scrollTop >= this.navTop && !this.isFixed ? (this.isFixed = 1, !this.dummyNav && 1005 < window.innerWidth && (e = r('<div class="vc-dummy-nav" style="height:' + this.$nav.outerHeight() + 'px"></div>'), this.$nav.after(e), this.dummyNav = e), this.$nav.addClass("vc_subnav-fixed")) : (this.scrollTop <= this.navTop && this.isFixed && 1005 < window.innerWidth || 1005 < window.innerWidth && 10 === this.scrollTop) && (this.isFixed = 0, this.dummyNav && 1005 < window.innerWidth && (this.dummyNav.remove(), this.dummyNav = !1), this.$nav.removeClass("vc_subnav-fixed"), this.setNavTop()), 0 !== this.$nav.length && (window.innerWidth <= 600 ? 46 < window.scrollY ? "0px" !== this.$nav.css("top") && this.$nav.css("top", "0") : (e = 46 - window.scrollY + "px", this.$nav.css("top") !== e && this.$nav.css("top", e)) : "" !== this.$nav.css("top") && this.$nav.css("top", "")))
      },
      ...
      handleDragOver: function(e) {
          vc.imageDrop && vc.imageDrop.handleDragOver(e)
      },
      ...
      handleTouchStart: function(e) {
          e = r(e.target).closest(".wpb_content_element");
          e.length && (this.$el.find(".wpb_content_element.vc_active").removeClass("vc_active"), e.addClass("vc_active"))
      }
  }), r(function() {
...
(i => {
  ...
  /// nectar addition end
  var s = vc.shortcodes,
      l = new RegExp("background:\\s*(.+?)\\s+url\\(\\s*['\"]?(.*?)['\"]?\\s*\\)"),
      r = new RegExp("background\\-image:\\s*url\\(([^)]+)\\)"),
      d = new RegExp("background-color:\\s*([^;!]+)");
  window.VcRowView = vc.shortcode_view.extend({
      change_columns_layout: !1,
      events: {
          'click > .vc_controls [data-vc-control="delete"]': "deleteShortcode",
          'touchstart > .vc_controls [data-vc-control="delete"]': "deleteShortcode",
          ...
          'touchstart > .vc_controls [data-vc-control="add"]': "addElement",
          'click > .vc_controls [data-vc-control="edit"]': "editElement",
          'touchstart > .vc_controls [data-vc-control="edit"]': "editElement",
          'click > .vc_controls [data-vc-control="clone"]': "clone",
          'touchstart > .vc_controls [data-vc-control="clone"]': "clone",
          'click > .vc_controls [data-vc-control="copy"]': "copy",
          'touchstart > .vc_controls [data-vc-control="copy"]': "copy",
          'click > .vc_controls [data-vc-control="paste"]': "paste",
          'touchstart > .vc_controls [data-vc-control="paste"]': "paste",
          'click > .vc_controls [data-vc-control="move"]': "moveElement",
          'touchstart > .vc_controls [data-vc-control="move"]': "moveElement",
          'click > .vc_controls [data-vc-control="toggle"]': "toggleElement",
          'touchstart > .vc_controls [data-vc-control="toggle"]': "toggleElement",
          "click > .wpb_element_wrapper .vc_controls": "openClosedRow",
          "touchstart > .wpb_element_wrapper .vc_controls": "openClosedRow",
          "touchstart > .vc_controls .vc_row_layouts": "toggleRowLayouts"
      },
      convertRowColumns: function(e) {
          ...
          return _.each(t, function(e, t) {
              var n, e = _.map(e.toString().split(""), function(e) {
                  return parseInt(e, 10)
              });
              i = 3 < e.length ? e[0] + "" + e[1] + "/" + e[2] + e[3] : 2 < e.length ? e[0] + "/" + e[1] + e[2] : e[0] + "/" + e[1], a.push(i), e = _.extend(_.isUndefined(o[t]) ? {} : o[t].get("params"), {
                  width: i
              ...
              _.each(s.where({
                  ...
                  vc.storage.lock(), e.save({
                      parent_id: _.last(c).id
                  }), vc.storage.lock(), e.trigger("change_parent_id")
              })
          }), _.each(o, function(e) {
              vc.storage.lock(), e.destroy()
          }, this), this.model.save(), this.setActiveLayoutButton("" + e), a
      },
      changeShortcodeParams: function(e) {
      ...
      controlSection: ".vc_controls.vc_controls-row.controls_row.vc_clearfix",
      ...
      setSorting: function() {
          ...
          vc_user_access().partAccess("dragndrop") && (1 < (e = this).$content.find(this.sortingSelector).length ? this.$content.removeClass("wpb-not-sortable").sortable({
              ...
              distance: .5,
              start: function(e, t) {
                  i("#wpbakery_content").addClass("vc_sorting-started"), t.placeholder.width(t.item.width())
              },
              stop: function() {
                  i("#wpbakery_content").removeClass("vc_sorting-started")
              },
              update: function() {
                  var n = i(e.sortingSelector, e.$content);
                  n.each(function() {
                      var e = i(this).data("model"),
                          t = i(this).index();
      ...
      layoutEditor: function() {
          return _.isUndefined(vc.row_layout_editor) && (vc.row_layout_editor = new vc.RowLayoutUIPanelBackendEditor({
              el: i("#vc_ui-panel-row-layout")
          })), vc.row_layout_editor
      },
      setColumns: function(e) {
          _.isObject(e) && e.preventDefault();
          var t, e = i(e.currentTarget);
          "custom" === e.data("cells") ? this.layoutEditor().render(this.model).show() : (vc.is_mobile && !(t = e.parent()).hasClass("vc_visible") && (t.addClass("vc_visible"), i(document).off("click.vcRowColumnsControl").on("click.vcRowColumnsControl", function() {
      ...
      sizeRows: function() {
          var t = 45;
          i("> .wpb_vc_column, > .wpb_vc_column_inner", this.$content).each(function() {
              var e = i(this).find("> .wpb_element_wrapper > .wpb_column_container").css({
                  minHeight: 0
              }).height();
              t < e && (t = e)
          }).each(function() {
              i(this).find("> .wpb_element_wrapper > .wpb_column_container").css({
                  minHeight: t
              })
          })
      },
      ...
      toggleRowLayouts: function(e) {
          i(e.currentTarget).toggleClass("vc_active")
      }
      ...
      events: {
          ...
          "clicktouchstart > .wpb_element_wrapper > .vc_empty-container": "addToEmpty"
      },
     ...
     //this.$el.find("> .vc_controls .vc_column_color").remove(), this.$el.find("> .vc_controls .vc_column_image").remove(), matches = css.match(/background\-image:\s*url\(([^\)]+)\)/), matches && !_.isUndefined(matches[1]) && (image = matches[1]), matches = css.match(/background\-color:\s*([^\s\;]+)\b/), matches && !_.isUndefined(matches[1]) && (color = matches[1]), matches = css.match(/background:\s*([^\s]+)\b\s*url\(([^\)]+)\)/), matches && !_.isUndefined(matches[1]) && (color = matches[1], image = matches[2]), image && jQuery('<span class="vc_column_image" style="background-image: url(' + image + ');" title="' + i18nLocale.column_background_image + '"></span>').insertBefore($column_toggle), color && jQuery('<span class="vc_column_color" style="background-color: ' + color + '" title="' + i18nLocale.column_background_color + '"></span>').insertBefore($column_toggle)
      ...
      addToEmpty: function(e) {
          e && e.preventDefault && e.preventDefault(), i(e.target).hasClass("vc_empty-container") && this.addElement(e)
      },
      setDropable: function() {
      ...
      setSorting: function() {
          var a;
          vc_user_access().partAccess("dragndrop") && (a = this).$content.sortable({
              forcePlaceholderSize: !0,
              placeholder: "widgets-placeholder",
              ...
              tolerance: "intersect",
              update: function(e, o) {
                  var c, t = o.item.data("element_type"),
                      n = o.item.parent().closest("[data-element_type]").data("element_type");
                  vc.check_relevance(n, t) && n != t && (c = i("> div.wpb_sortable,> div.vc-non-draggable", a.$content)).each(function() {
                      var e, t = i(this).data("model"),
                          n = i(this).index();
                      t.set("order", n), c.length - 1 > n && vc.storage.lock(), _.isNull(o.sender) || (n = o.item.parent().closest("[data-model-id]").data("model"), e = t.get("parent_id"), vc.storage.lock(), t.save({
                          parent_id: n.id
                      }), e && vc.app.views[e].checkIsEmpty(), vc.app.views[n.id].checkIsEmpty()), t.save()
                  })
              },
              stop: function(e, t) {
                  i("#wpbakery_content").removeClass("vc_sorting-started"), i(".dragging_in").removeClass("dragging_in");
                  var n = t.item.data("element_type"),
                      t = t.item.parent().closest("[data-element_type]").data("element_type");
                  vc.check_relevance(t, n) && t != n || i(this).sortable("cancel"), i(".vc_sorting-empty-container").removeClass("vc_sorting-empty-container")
              },
              over: function(e, t) {
                  var n = t.item.data("element_type"),
                      o = t.placeholder.closest("[data-element_type]").data("element_type") || "",
                      c = !!_.isUndefined(vc.map[o].allowed_container_element) || vc.map[o].allowed_container_element;
      ...
      events: {
          ...
          "touchstart .add_tab": "addTab",
          "click > .vc_controls .column_delete, > .vc_controls .vc_control-btn-delete": "deleteShortcode",
          "touchstart > .vc_controls .column_delete, > .vc_controls .vc_control-btn-delete": "deleteShortcode",
          "click > .vc_controls .column_edit, > .vc_controls .vc_control-btn-edit": "editElement",
          "touchstart > .vc_controls .column_edit, > .vc_controls .vc_control-btn-edit": "editElement",
          "click > .vc_controls .column_clone,> .vc_controls .vc_control-btn-clone": "clone",
          "touchstart > .vc_controls .column_clone,> .vc_controls .vc_control-btn-clone": "clone",
          // nectar addition
      ...
      render: function() {
        // nectar addition. vc_accordion_tab to toggles
          return window.VcAccordionView.__super__.render.call(this), vc_user_access().shortcodeAll("toggles") ? vc_user_access().partAccess("dragndrop") && this.$content.sortable({
              ...
              handle: "h3",
              stop: function(e, t) {
                  t.item.prev().triggerHandler("focusout"), i(this).find("> .wpb_sortable").each(function() {
      ...
      events: {
          ...
          "touchstart > [data-element_type] > .vc_controls .vc_control-btn-delete": "deleteShortcode",
          "click > [data-element_type] >  .vc_controls .vc_control-btn-prepend": "addElement",
          "touchstart > [data-element_type] >  .vc_controls .vc_control-btn-prepend": "addElement",
          "click > [data-element_type] >  .vc_controls .vc_control-btn-edit": "editElement",
          "touchstart > [data-element_type] >  .vc_controls .vc_control-btn-edit": "editElement",
          "click > [data-element_type] > .vc_controls .vc_control-btn-clone": "clone",
          "touchstart > [data-element_type] > .vc_controls .vc_control-btn-clone": "clone",
          "click > [data-element_type] > .wpb_element_wrapper > .vc_empty-container": "addToEmpty",
          "touchstart > [data-element_type] > .wpb_element_wrapper > .vc_empty-container": "addToEmpty"
      },
      setContent: function() {
      ...
      setEmpty: function() {
          i("> [data-element_type]", this.$el).addClass("vc_empty-column"), "edit" !== vc_user_access().getState("shortcodes") && this.$content.addClass("vc_empty-container")
      },
      unsetEmpty: function() {
          i("> [data-element_type]", this.$el).removeClass("vc_empty-column"), this.$content.removeClass("vc_empty-container")
      }
      ...
      changeShortcodeParams: function(e) {
          ...
          switch (window.VcMessageView_Backend.__super__.changeShortcodeParams.call(this, e), t = e.get("params"), e = this.$el.find("> .wpb_element_wrapper"), n = ["vc_message_box"], _.isUndefined(t.message_box_style) && (t.message_box_style = "classic"), _.isUndefined(t.message_box_color) && (t.message_box_color = "alert-info"), t.style ? "3d" === t.style ? (t.message_box_style = "3d", t.style = "rounded") : "outlined" === t.style ? (t.message_box_style = "outline", t.style = "rounded") : "square_outlined" === t.style && (t.message_box_style = "outline", t.style = "square") : t.style = "rounded", n.push("vc_message_box-" + t.style), t.message_box_style && n.push("vc_message_box-" + t.message_box_style), e.attr("class", "wpb_element_wrapper"), e.find(".vc_message_box-icon").remove(), o = _.isUndefined(t["icon_" + t.icon_type]) ? "fa fa-info-circle" : t["icon_" + t.icon_type], c = t.color, t.color) {
              ...
              case "alert-danger":
                  ...
                  break;
              default:
                  c = t.message_box_color
          }
          n.push("vc_color-" + c), e.addClass(n.join(" ")), e.prepend(i('<div class="vc_message_box-icon"><i class="' + o + '"></i></div>'))
      }
      ...
      changeShortcodeParams: function(e) {
          ...
          _.isObject(e) && _.isString(e.title_align) && t.removeClass(_.values(this.params.title_align.value).join(" ")).addClass(e.title_align), _.isObject(e) && _.isString(e.add_icon) && "true" === e.add_icon && ((e = i('<i class="' + e["i_icon_" + e.i_type] + '" ></i>')).prependTo(t.find("[name=title]")), e.after(" "))
      }
      ...
      toggle: function(e) {
          e && e.preventDefault && e.preventDefault(), i(e.currentTarget).toggleClass("vc_toggle_title_active"), i(".vc_toggle_content", this.$el).slideToggle(500)
      },
      changeShortcodeParams: function(e) {
          window.VcToggleView.__super__.changeShortcodeParams.call(this, e), e = e.get("params"), _.isObject(e) && _.isString(e.open) && "true" === e.open && i(".vc_toggle_title", this.$el).addClass("vc_toggle_title_active").next().show()
      }
      ...
      events: {
          ...
          "touchstart > .vc_controls .vc_control-btn-delete": "deleteShortcode",
          "click > .vc_controls .vc_control-btn-edit": "editElement",
          "touchstart > .vc_controls .vc_control-btn-edit": "editElement",
      ...
      createAddTabButton: function() {
          ...
          this.$tabs.append('<div id="new-tab-' + e + '" class="new_element_button"></div>'), this.$add_button = i('<li class="add_tab_block"><a href="#new-tab-' + e + '" class="add_tab" title="' + window.i18nLocale.add_tab + '"></a></li>').appendTo(this.$tabs.find(".tabs_controls")), vc_user_access().shortcodeAll("tab") || this.$add_button.hide()
      },
      addTab: function(e) {
           /* nectar addition */
            // nectar addition vc_tab to tab
      ...
      stopSorting: function() {
          ...
          this.$tabs.find("ul.tabs_controls li:not(.add_tab_block)").each(function() {
              i(this).find("a").attr("href").replace("#", "");
              e = vc.shortcodes.get(i("[id=" + i(this).attr("aria-controls") + "]").data("model-id")), vc.storage.lock(), e.save({
                  order: i(this).index()
              })
          }), e && e.save()
      },
      ...
      changedContent: function(view) {
        ...
        if (!this.$tabs.hasClass('ui-tabs')) {
            ...
            // nectar addition - fixing bug with gallery inside of tabs when duplicating.
            // The .tabs_controls sometimes ends up not as the first ul, so it won't be used for the navigation in .tabs and will break.
            // we cna fix that by moving it to the top of the tabs to ensure it is picked up as the navigation.
            if (this.$tabs.find('> ul.tabs_controls').length > 0) {
                var tabControls = this.$tabs.find('> ul.tabs_controls').detach();
                // prepend to tabs to ensure they are first and picked up as the navigation instad of another UL, such as the image gallery preview.
                this.$tabs.prepend(tabControls);
            }
            // nectar addition end.
            ...
            // attachment thumbnails is getting ui-
      ...
      events: {
          ...
          "touchstart > .vc_controls .vc_control-btn-prepend": "addElement",
          "click > .vc_controls .vc_control-btn-edit": "editElement",
          "touchstart > .vc_controls .vc_control-btn-edit": "editElement",
          "click > .vc_controls .vc_control-btn-clone": "clone",
          "touchstart > .vc_controls .vc_control-btn-clone": "clone",
          "click > .wpb_element_wrapper > .vc_empty-container": "addToEmpty",
          "touchstart > .wpb_element_wrapper > .vc_empty-container": "addToEmpty"
      },
       /* nectar addition */
       render:function () {
    ...
    /* nectar addition end */
      ...
      events: {
          ...
          "touchstart > .vc_controls .vc_control-btn-prepend": "clickPrependSection",
          "click .vc_tta-section-append": "clickAppendSection",
          "touchstart .vc_tta-section-append": "clickAppendSection"
      },
      initialize: function(e) {
      ...
      notifySectionRendered: function() {},
      ...
      notifySectionRendered: function(e) {
          var t, n;
          window.VcBackendTtaTabsView.__super__.notifySectionRendered.call(this, e), t = e.getParam("title"), t = i(this.getParsedNavigationSectionTemplate({
              model_id: e.get("id"),
      ...
      events: {
          ...
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-delete": "deleteShortcode",
          "click > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-prepend": "addElement",
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-prepend": "addElement",
          "click > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-edit": "editElement",
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-edit": "editElement",
          "click > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-clone": "clone",
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-clone": "clone",
          "click > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-copy": "copy",
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-copy": "copy",
          "click > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-paste": "paste",
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_controls .vc_control-btn-paste": "paste",
          "click > .wpb_element_wrapper > .vc_tta-panel-body > .vc_empty-container": "addToEmpty",
          "touchstart > .wpb_element_wrapper > .vc_tta-panel-body > .vc_empty-container": "addToEmpty"
      },
      setContent: function() {
...
jQuery(window).on("load", function() {
  var t;
  vc.backendEditorParamsAjaxStorage && (jQuery.ajax({
      type: "POST",
      url: window.ajaxurl,
      data: {
          action: "wpb_backend_editor_params",
          elements: vc.backendEditorParamsAjaxStorage,
          _vcnonce: window.vcAdminNonce
      },
      dataType: "json"
  }).done(function(a) {
      a.success ? jQuery.each(a.data, function(a, e) {
          t[e.action](a, e)
      }) : console.warn("Failed to get element params from server")
  }).fail(function() {
      console.warn("Failed to get element params from server")
  }), t = {
      get_attach_image: function(a, e) {
          var t = jQuery('[data-model-id="' + a + '"]');
          t.length ? (t = t.find(".attachment-thumbnail[data-name=" + e.paramName + "]"), vc.atts.attach_image.updateImage(t, e, !0)) : console.warn('Element with data-model-id="' + a + '" not found')
      },
      get_gallery_images: function(a, e) {
          var t = jQuery('[data-model-id="' + a + '"]');
          t.length ? (t = t.find(".attachment-thumbnails[data-name=" + e.paramName + "]"), vc.atts.attach_images.updateImages(t, e.html)) : console.warn('Element with data-model-id="' + a + '" not found')
      }
  })
});
(o => {
  var t = function(t, i, n) {
      this.target = t, this.$pointer = null, this.texts = n, this.pointerOptions = i, this.init()
  };
  t.prototype = {
      init: function() {
      ...
      openedEvent: function(t, i) {
          var n = i.pointer.offset();
          i.pointer.css("z-index", 1e5), n && n.top && o("body").scrollTop(80 < n.top ? n.top - 80 : 0)
      },
      reposition: function() {
          this.$pointer.length && o.contains(document, this.$pointer[0]) ? (this.$pointer.pointer("reposition"), window.vcPointersUpdatePosition(this.$pointer)) : this.close()
      },
      close: function() {
...
(i => {
  ...
  t.prototype = {
      ...
      getPointer: function(t) {
          return this.pointerData = this.pointers[t] && this.pointers[t].target ? this.pointers[t] : null, this.pointerData && this.pointerData.options ? (i("body").hasClass("vc_editor") && "#vc_ui-panel-post-custom-layout" === this.pointerData.target && "none" === i(this.pointerData.target).css("display") && this.next(), new vcPointerMessage(this.pointerData.target, this.buildOptions(this.pointerData.options), this._texts)) : null
      },
      ...
      show: function() {
          this.pointer.show(), this.setCloseEventHandler(), vc.events.trigger("vcPointer:show"), window.vcPointersUpdatePosition(this.pointer.$pointer)
      },
...
(i => {
  ...
  }, window.vcPointersUpdatePosition = function(t) {
      var n = t.data("wpPointer"),
          o = i("#vc_post-custom-layout").val(),
          e = t[0] && t[0].getBoundingClientRect(),
          t = t.hasClass("vc_controls-cc");
      "admin_frontend_editor" === window.vc_mode && n && "blank" === o && t && e.top < 90 && (o = n.pointer, t = n.arrow, n = e.top + e.height / 2, o.css("top", "10px"), t.css("top", n - 10 + "px"))
  }
})(window.jQuery);
(() => {
  var i = {
...
(e => {
  e(function() {
      var o, d, n;
      window.vc && window.vc.events && (o = e(".vc_undo-button"), d = e(".vc_redo-button"), n = function(o) {
...
window.vc || (window.vc = {}), (() => {
  ...
  var a = function(o, e, t) {
          var r, c, n, i, a, s, d, l, p = !0;
          return o ? (e = (o = h(o, e, t)).isModelRow, r = o.isModelRowInner, c = o.isModelTtaSection, n = o.isModelTtaToggleSection, i = o.isTopShortcodeRow, a = o.isTopShortcodeRowInner, s = o.isTopShortcodeSection, d = o.containerPreventsShortcode, p = (l = o.isShortcodeContainer) && (d && !((c || n) && a) || !d && (c || n) && i || e && !(i || s) || r && !a || o.isModelColumn && i || o.isModelColumnInner && (a || i)) || !l && (e || r) || (o.shortcodeRejectsAsChild || o.containerRejectsAsParent) && !(s && (o.isModelSection || e))) : "vc_row" === t[0].shortcode && (p = !1), p
      },
      s = function(o, e, t, r) {
          var c, n, i, a, s, d = Object.assign({}, e);
          return o && (t = (e = h(o, e, t)).isModelRow, c = e.isModelRowInner, n = e.isModelSection, i = e.isTopShortcodeRow, a = e.isTopShortcodeRowInner, s = e.isTopShortcodeSection, e = e.isModelContainer, d.params.tab_id && (d.params.tab_id = Date.now() + "-" + vc_guid()), c && a || t && i || !o.get("parent_id") && (!n || !i) ? (r && (d.place_after_id = o.get("id")), d.parent_id = o.get("parent_id")) : e && !t && (d.parent_id = o.get("id")), (t || c) && (i || a) || (t || n) && s) && (d.order = parseFloat(o.get("order")) + vc.clone_index), r ? (r.create(d), r.last()) : vc.shortcodes.create(d)
      },
      h = function(o, e, t) {
          ...
          return {
              ...
              isModelTtaToggleSection: "vc_tta_toggle_section" === o,
...
window.vc || (window.vc = {}), (() => {
  function a(e, o, c, t) {
      var a = e ? e.querySelector(".wpb-color-picker") : null,
          n = e ? e.querySelector(".vc_color-control") : null,
          r = n && n.hasAttribute("data-default-colorpicker-color") ? n.getAttribute("data-default-colorpicker-color") : "",
          l = e && (n.value || r) || "",
          a = {
              el: a,
              container: e,
      ...
      i.on("change", _.debounce(function(e) {
          n.value = e.toHEXA().toString(), i.applyColor(), c && c.change && c.change(n)
      }, 200)).on("cancel", _.debounce(function() {
          var e = n.dataset.prevColor || l;
          n.value = e, i.setColor(e), c && c.cancel && c.cancel(n)
      }, 200)).on("hide", function() {
          n.dataset.prevColor = n.value, i.hide()
      }).on("clear", _.debounce(function() {
         // nectar addition - core wpb bug which gets data-default-value instead of data-default-colorpicker-color. Different params are used in different places, and both need to be
        // considered until wpb standardizes their usage.
        r = n.getAttribute("data-default-value");
        if ( n.hasAttribute("data-default-colorpicker-color") ) {
            r = n.getAttribute("data-default-colorpicker-color");
        }
        // nectar addition end
          n.value = r, c && c.change && c.change(n), n.dataset.prevColor = r, i.setColor(r)
      }, 200)), t.push(i)
  }
  vc.initColorPicker = function(e, o, c, t) {
      o = o || {}, c = c || {}, t = t || [];
      e = (e || document).querySelectorAll(".color-group");
      try {
          o && o.single ? a(null, o, c, t) : e.length && e.forEach(function(e) {
              a(e, o, c, t)
          })
      } catch (e) {
