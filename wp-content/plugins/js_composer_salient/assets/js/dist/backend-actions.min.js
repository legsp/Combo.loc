...
(d => {
  vc.events.on("vc:access:initialize", function(e) {
      ...
      var t = null,
        ...
        /* nectar addition */
        var $btnLocation = (jQuery('#nectar-metabox-portfolio-extra').length == 0) ? n : jQuery('#post-body-content');
        // add $btnLocation to insertAfter below
        /* nectar addition end */
        n.length ? (e.can("fe_editor") && (i = '<a class="wpb_switch-to-front-composer" href="' + d("#wpb-edit-inline").attr("href") + '">' + window.i18nLocale.main_button_title_frontend_editor + "</a>"), e.can("classic_editor") ? e.can("be_editor") && (o = '<a class="wpb_switch-to-composer" href="javascript:;">' + window.i18nLocale.main_button_title_backend_editor + "</a>") : (s.addClass("vc-disable-editor"), e.can("be_editor") && !vc_user_access().isBlockEditorIsEnabled() && _.defer(function() {
            vc.events.trigger("vc:backend_editor:show")
        })), window.wpbIsGutenberg && (c = '<a class="wpb_switch-to-gutenberg" href="' + window.wpbGutenbergEditorSwitchUrl + '">' + window.i18nLocale.main_button_title_gutenberg + "</a>"), (i || o || c) && (t = n.length ? d('<div class="composer-switch"><div class="composer-inner-switch"><span class="logo-icon"></span>' + o + i + "</div>" + c + "</div>").insertAfter($btnLocation) : d('<div class="composer-switch"><div class="composer-inner-switch"><span class="logo-icon"></span>' + o + i + "</div>" + c + "</div>").prependTo("#post-body-content"), e.can("classic_editor")) && (window.vc_modules.hasOwnProperty("vc-ai") && !window.vc_modules["vc-ai"] || s.prepend('<div class="vc_ui-icon-ai" data-wpb-ai-element-type="textarea_html" data-field-id="content" title="WPBakery AI Assistant">\n\t<svg xmlns="http://www.w3.org/2000/svg" height="19px" width="19px" viewBox="0 0 20 20" fill="currentColor">\n\t\t<path d="M13 7H7v6h6V7z"></path>\n\t\t<path fill-rule="evenodd" d="M7 2a1 1 0 012 0v1h2V2a1 1 0 112 0v1h2a2 2 0 012 2v2h1a1 1 0 110 2h-1v2h1a1 1 0 110 2h-1v2a2 2 0 01-2 2h-2v1a1 1 0 11-2 0v-1H9v1a1 1 0 11-2 0v-1H5a2 2 0 01-2-2v-2H2a1 1 0 110-2h1V9H2a1 1 0 010-2h1V5a2 2 0 012-2h2V2zM5 5h10v10H5V5z" clip-rule="evenodd"></path>\n\t</svg>\n\t<span>AI</span>\n</div>'), t.find(".wpb_switch-to-composer").on("click", function() {
            vc.events.trigger("vc:backend_editor:switch"), window.dispatchEvent(new Event("resize"))
        }))) : a && window.wp.data.subscribe(function() {
            setTimeout(function() {
                var e, t = a ? a.querySelector(".edit-post-header-toolbar") : null;
                t && !t.querySelector(".composer-switch") && (e = d('<div class="composer-switch"><div class="composer-inner-switch"><a data-toolbar-item="true" class="wpb_switch-to-composer" href="' + window.wpbGutenbergEditorBackendSwitchUrl + '"><span class="logo-icon"></span><span class="composer-switch-text">' + window.i18nLocale.main_button_title + "</span></a></div></div>"), t.querySelector(".edit-post-header-toolbar__left") ? t.querySelector(".edit-post-header-toolbar__left").after(e.get(0)) : t.append(e.get(0)))
            }, 100)
        });
  })
})(window.jQuery);