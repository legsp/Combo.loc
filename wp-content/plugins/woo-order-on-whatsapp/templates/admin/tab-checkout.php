...
<div id="tab-checkout-content" class="myd-tabs-content">
    ...
    <textarea name="evwapp_opiton_product_order_message" class="large-text" rows="6"><?php echo get_option( 'evwapp_opiton_product_order_message' ); ?></textarea>
    ...
    <textarea name="evwapp_opiton_order_message" class="large-text" rows="20"><?php echo get_option( 'evwapp_opiton_order_message' ); ?></textarea>
