	...
	<h2><?php esc_html_e( 'General Settings', 'woo-order-on-whatsapp' );?></h2>
		<table class="form-table">
			<tbody>
				...
				<tr>
					<th scope="row">
						<label for="evwapp_opiton_show_thank"><?php esc_html_e( 'Auto redirect after checkout?', 'woo-order-on-whatsapp' );?> </label>
					</th>
					<td>
						<input type="checkbox" name="evwapp_opiton_show_thank" id="evwapp_opiton_show_thank" value="yes" <?php checked( get_option('evwapp_opiton_show_thank'), 'yes' );?>><?php esc_html_e( 'Yes, redirect after checkout.', 'woo-order-on-whatsapp' );?>
		...
		<div class="card">
			<h3><?php esc_html_e( 'Widget for Elementor', 'woo-order-on-whatsapp' );?> </h3>
